...
import amEntityFactory = require("../a_entity/AFactory_Entity");

export module am_general
{
  export interface AEFactory_LiveCommandsSettings extends amEntityFactory.am_general.AFactory_Entity
  {
