...
export module am_general
{
  export interface I_Service extends amGeneral.am_general.I_Interface
  {
    ...
    getServiceLocator() : amConfigurationServicesServiceLocator.am_configurationservices.A_ServiceLocator;
    setServiceLocator(aServiceLocator : amConfigurationServicesServiceLocator.am_configurationservices.A_ServiceLocator) : void;
    
    getServiceContainer() : amConfigurationServicesServiceContainer.am_configurationservices.A_ServiceContainer;
    setServiceContainer(aServiceContainer : amConfigurationServicesServiceContainer.am_configurationservices.A_ServiceContainer) : void;
    ...
    setUtilsService(aUtilsService: amTransversalServicesUtilsService.am_transversalservices.A_UtilsService) : void;
    setSDKService(aSDKService: amTransversalServicesSDKService.am_transversalservices.A_SDK_JsTV) : void;
