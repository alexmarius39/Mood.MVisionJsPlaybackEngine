...
export module am_coreservices
{
  export interface AE_PlaylistItem_Logic extends amGeneral.am_general.A_Entity
  {
    ...
    canReuseAlreadyCreatedRenderingZone() : boolean;
    setCanReuseAlreadyCreatedRenderingZone(canReuseAlreadyCreatedRenderingZone: boolean);

    canDestroyAlreadyCreatedRenderingZone() : boolean;
    setCanDestroyAlreadyCreatedRenderingZone(canDestroyAlreadyCreatedRenderingZone: boolean);
    ...
    //---------------------------------                                 
    shutdown(  error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback) : number;
