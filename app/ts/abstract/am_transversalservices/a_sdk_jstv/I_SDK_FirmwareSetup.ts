...
export module am_transversalservices
{
  export interface I_SDK_FirmwareSetup extends amGeneral.am_general.I_Interface
  {
    ...
    getFirmwareVersion(error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback) : void;
    promise_getFirmwareVersion(error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback) : void;
  }
} 