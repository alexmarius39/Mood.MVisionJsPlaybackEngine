...
export module am_transversalservices
{
  export interface I_SDK_GeneralConfiguration extends amGeneral.am_general.I_Interface
  {
    ...
    getUpTime(error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback) : void;
    promise_getUpTime(error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback) : any;
