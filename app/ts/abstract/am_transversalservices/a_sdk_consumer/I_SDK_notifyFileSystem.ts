...
export module am_transversalservices
{
  export interface I_SDK_notifyFileSystem extends amGeneral.am_general.I_Interface
  {
    ...
    notify_readBinaryFile(storageName: string, folderName: string, fileName: string, error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback) : void
    ...
    notify_getLastModified(aFileInfo:amGeneralFileInfo.am_general.A_FileInfo,  error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback): void
  }
} 