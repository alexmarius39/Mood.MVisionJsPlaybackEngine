...
export module am_transversalservices
{
  export interface I_SDK_notifyFirmwareSetup extends amGeneral.am_general.I_Interface
  {
    ...
    notify_getFirmwareVersion(error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback) : void;
    notify_promise_getFirmwareVersion(error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback) : void;
