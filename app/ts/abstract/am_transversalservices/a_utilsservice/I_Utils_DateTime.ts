...
export module am_transversalservices
{
  export interface I_Utils_DateTime extends amGeneral.am_general.I_Interface
  {
    ...
    getDateTime(aDateTime: amGeneralDateTime.am_general.A_DateTime, strDate: string) : void;
    getCrtDateTime(aDateTime: amGeneralDateTime.am_general.A_DateTime) : void;
    getCrtDateTimeAsISOString(aDateTime: amGeneralDateTime.am_general.A_DateTime) : string;
    getDateTimeAsISOString(aDateTime: amGeneralDateTime.am_general.A_DateTime, strDate: string) : string;
    getCrtDateTimeAsISOString2() : string;
    getCrtDateTimeAsString(formatDate: string, formatTime: string) : string;
    getCrtDateTimeAsString2(formatDate: string, formatTime: string, separator: string) : string;

    getCrtUTCDateTime(aDateTime: amGeneralDateTime.am_general.A_DateTime) : void;
    getCrtUTCDateTimeAsISOString(aDateTime: amGeneralDateTime.am_general.A_DateTime) : string;
