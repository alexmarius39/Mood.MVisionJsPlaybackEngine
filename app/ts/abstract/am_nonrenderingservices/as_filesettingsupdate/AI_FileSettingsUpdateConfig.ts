...
{
  export interface AI_FileSettingsUpdateConfig extends amGeneral.am_general.I_Interface
  {
    _name: string; 
    ...
    getMainDebugParamAsBoolean(): boolean;

    getAppServerBaseUrl(): string;
    getAppServerBasePath(): string;
  }
} 