...
export module rm_general
{
                                   ...
                                   implements amGeneralNetworkProperties.am_general.A_NetworkProperties
  {
    ...
    public copyFromJson(jsonNetworkProperties: any): void
    {
    ...
    public getWiredNetCardProperties()
    {
      return this._wiredNetCardProp;
    }

    public getWifiNetCardProperties()
    {
      return this._wifiNetCardProp;
    }

    public getProxyNetProperties()
    {
      return this._proxyNetProp;
    }

    public getWifiConnInfo()
    {
