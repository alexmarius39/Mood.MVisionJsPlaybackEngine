...
import mod_RS_TestService  = require("../../../../../app/ts/reusable/rm_renderingservices/rs_testservice/RS_TestService");
...
export module rm_nonrenderingservices
{
                                          ...
                                          implements amGeneralServiceFactory.am_general.AFactory_Service
  {
                             ...
                             : amGeneralService.am_general.A_Service
    {
      ...
      //{  
        return new mod_RS_TestService.rm_renderingservices.RS_TestService(aFactoryDescription, aServiceContainer, aLogService, error); 
      //});
