...
export module rm_renderingservices
{
                                 ...
                                 implements amRenderingServices.am_renderingservices.A_RenderingZone
  {
                              ...
                              error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback) : void
    {
      ...
      {
        owner._aActivityLogService._IActivityLogServiceMessaging.addLogMessage(amGeneralActivityLogMessageTypes.am_general.AE_LogMessageTypes.Info, owner.getServiceName(),                          
        "  Stop IMAGE - " +
        " zoneId: "    + owner._zoneId +
