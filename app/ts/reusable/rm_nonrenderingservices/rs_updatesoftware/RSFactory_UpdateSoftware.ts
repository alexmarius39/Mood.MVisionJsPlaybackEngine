...
import mod_RS_UpdateSoftware  = require("../../../../../app/ts/reusable/rm_nonrenderingservices/rs_updatesoftware/RS_UpdateSoftware");
...
export module rm_coreservices
{
                                            ...
                                            implements amGeneralServiceFactory.am_general.AFactory_Service
  {
                             ...
                             : amGeneralService.am_general.A_Service
    {
      ...
      //{  
        return new mod_RS_UpdateSoftware.rm_nonrenderingservices.RS_UpdateSoftware(aFactoryDescription, aServiceContainer, aLogService, error); 
      //});
