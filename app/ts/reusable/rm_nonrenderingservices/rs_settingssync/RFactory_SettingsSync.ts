...
import R_SettingsSyncService  = require("./RS_SettingsSync");

export module rm_nonrenderingservices
{
  export class RFactory_SettingSyncService   extends rmGeneralServiceFactory.rm_general.RFactory_Service 
