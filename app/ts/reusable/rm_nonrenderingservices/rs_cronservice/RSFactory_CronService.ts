...
import mod_R_ChronService  = require("../../../../../app/ts/reusable/rm_nonrenderingservices/rs_cronservice/RS_CronService");

export module rm_nonrenderingservices
{
  export class RSFactory_CronService   extends rmGeneralServiceFactory.rm_general.RFactory_Service 
