...
import R_VolumeSetupService  = require("./RS_VolumeSetup");

export module rm_nonrenderingservices
{
  export class RFactory_VolumeSetupService  extends rmGeneralServiceFactory.rm_general.RFactory_Service 
