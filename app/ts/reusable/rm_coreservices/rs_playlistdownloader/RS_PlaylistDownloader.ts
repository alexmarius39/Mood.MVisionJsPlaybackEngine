...
import rmIImplPlaylistDownloaderConfig  = require("../../../../../app/ts/reusable/rm_coreservices/rs_playlistdownloader/IImpl_PlaylistDownloaderConfig_R");
import rmIImplPlaylistDownloaderBuilderMoodV5   = require("../../../../../app/ts/reusable/rm_coreservices/rs_playlistdownloader/IImpl_PlaylistDownloaderBuilder_Mood_v5");
import rmIImplPlaylistDownloaderBuilderCustomV1 = require("../../../../../app/ts/reusable/rm_coreservices/rs_playlistdownloader/IImpl_PlaylistDownloaderBuilder_Custom_v1");
import rmIImplPlaylistDownloaderMain    = require("../../../../../app/ts/reusable/rm_coreservices/rs_playlistdownloader/IImpl_PlaylistDownloaderMain_R");
import { string_to_bytes } from "../../rm_transversalservices/r_utilsservice/asmcryptoes5/other/utils";


export module rm_coreservices
{
  export class RS_PlaylistDownloader extends  rmGeneral.rm_general.R_Service 
                                     implements amCoreServicesPlaylistDownloader.am_coreservices.AS_PlaylistDownloader
  {
    //---------- interfaces
    ...
    {      
      ...
      this._iPlaylistDownloaderConfig            = new rmIImplPlaylistDownloaderConfig.rm_coreservices.IImpl_PlaylistDownloaderConfig_R(this);
      this._iPlaylistDownloaderBuilderMoodV5     = new rmIImplPlaylistDownloaderBuilderMoodV5.rm_coreservices.IImpl_PlaylistDownloaderBuilder_Mood_v5(this);
      this._iPlaylistDownloaderBuilderCustomV1   = new rmIImplPlaylistDownloaderBuilderCustomV1.rm_coreservices.IImpl_PlaylistDownloaderBuilder_Custom_v1(this);
      this._iPlaylistDownloaderMain              = new rmIImplPlaylistDownloaderMain.rm_coreservices.IImpl_PlaylistDownloaderMain_R(this);
              ...
              var callbackApplyCorrectiveNewsRendererJs = function callbackApplyCorrectiveNewsRendererJs(ctxApplyCorrectiveNewsRendererJs)
              {
                ...
                var callbackApplyCorrectiveNewsApiWraperJs = function callbackApplyCorrectiveNewsRendererJs(ctxApplyCorrectiveNewsApiWraperJs)
                {
                  ...
                  var callbackApplyCorrectiveforVideoWithText = function callbackforVideoWithText(ctxApplyCorrectiveNewsApiWraperJs)
                  {
                    ...
                    //-------------------------------------
                    var errorApplyCorrectiveWeatherRendererJs:amGeneralError.am_general.A_Error       = self._aServiceLocator._iEntityCreation.createDefaultError();   
                    var contextApplyCorrectiveWeatherRendererJs:amGeneralContext.am_general.A_Context = self._aServiceLocator._iEntityCreation.createDefaultContext();    
                    var callbackApplyCorrectiveWeatherRendererJs = function callbackApplyCorrectiveWeatherRendererJs(ctxApplyCorrectiveWeatherRendererJs)
                    {
                      ...
                      //-------------------------------------
                      var errorApplyCorrectiveWeatherApiWrapperJs:amGeneralError.am_general.A_Error       = self._aServiceLocator._iEntityCreation.createDefaultError();   
                      var contextApplyCorrectiveWeatherApiWrapperJs:amGeneralContext.am_general.A_Context = self._aServiceLocator._iEntityCreation.createDefaultContext();    
                      ...
                      self.applyCorrectiveJs_forOneHtmlTemplate_forJsFile( 
                                  ...
                                  errorApplyCorrectiveWeatherApiWrapperJs, contextApplyCorrectiveWeatherApiWrapperJs, callbackApplyCorrectiveWeatherApiWrapperJs);
                    ...
                    self.applyCorrectiveJs_forOneHtmlTemplate_forJsFile( 
                                  ...
                                  aHtmlTemplateMainFilesTransferList, aHtmlTemplateDetailFilesTransferList,
                                  playlistType, aPlaylistTransferFile, aMediaFilesTransferFileBase, aHtmlTemplatesFilesTransferFileBase, 
                                  errorApplyCorrectiveWeatherRendererJs, contextApplyCorrectiveWeatherRendererJs, callbackApplyCorrectiveWeatherRendererJs);
...
*/
    ...
    //-----------------------------------
    public cleanupCurrentPlaylist(aPlaylistTransferFile: amGeneralFileTransfer.am_general.AE_FileTransfer,
                                  error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
    {
      const self = this;
      const aPlaylistTmpFolder = aPlaylistTransferFile.getTmpFileInfo();
      const callbackDeletePlaylistTmpFolder = function callbackDeletePlaylistTmpFolder(ctx1 : amGeneralContext.am_general.A_Context){
        const callbackCreatePlaylistTmpFolder = function callbackCreatePlaylistTmpFolder(ctx2 : amGeneralContext.am_general.A_Context){
          context != null && context.setError(error);
          callback != null && callback(context);  
        }

        const errorCreatePlaylistTmpFolder:amGeneralError.am_general.A_Error        = self._aServiceLocator._iEntityCreation.createDefaultError();   
        const contextCreatePlaylistTmpFolder:amGeneralContext.am_general.A_Context  = self._aServiceLocator._iEntityCreation.createDefaultContext();  
      ...
      const errorDeletePlaylistTmpFolder:amGeneralError.am_general.A_Error        = self._aServiceLocator._iEntityCreation.createDefaultError();   
      const contextDeletePlaylistTmpFolder:amGeneralContext.am_general.A_Context  = self._aServiceLocator._iEntityCreation.createDefaultContext();  
    ...
    //========================================================
    public createPlaylistFoldersIfTheyNotExists(error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
    {
      const self = this;
      const aPlaylistTmpFolder = this._aPlaybackGlobalConfig._aPlaylistTemporaryFile;
      const aPlaylistFolder    = this._aPlaybackGlobalConfig._aPlaylistFile;

      //---------------------------------------------
      const callbackCreatePlaylistTmpFolder = function callbackCreatePlaylistTmpFolder() {
        const callbackCreatePlaylistFolder = function callbackCreatePlaylistFolder() {
          context != null && context.setError(error);
          callback != null && callback(context);
        }

        const errorCreatePlaylistFolder:amGeneralError.am_general.A_Error         = self._aServiceLocator._iEntityCreation.createDefaultError();   
        const contextCreatePlaylistFolder:amGeneralContext.am_general.A_Context   = self._aServiceLocator._iEntityCreation.createDefaultContext();  
    ...
    {   
      ...
      var callbackCreateFolders = function callbackCreateFolders()
      {
        ...
        self.downloadAll( playlistType, aPlaylistTransfer, aMediaFilesTransfer, aHtmlTemplatesFilesTransfer, 
    ...
    {
      const self = this;
      const errorPlaylistTransferFile:amGeneralError.am_general.A_Error       = self._aServiceLocator._iEntityCreation.createDefaultError();   
      const aPlaylistTransferFile: amGeneralFileTransfer.am_general.AE_FileTransfer = self._aServiceLocator._iEntityCreation.createDefaultFileTransfer(errorPlaylistTransferFile);
      ...
      const cbCreatePlaylistFolders = function cbCreatePlaylistFolders(ctx0: amGeneralContext.am_general.A_Context) {
        const cbHasNewPlaylist = function cbHasNewPlaylist(ctx1: amGeneralContext.am_general.A_Context) {
          if (ctx1 != null && !ctx1.isError()) {
            const bHasNewPlaylist:boolean = ctx1.getBoolResult();
            ...
            const cbCleanup = function cbCleanup(ctx2: amGeneralContext.am_general.A_Context) {
              if (ctx2 != null && !ctx2.isError()) {
                const cbDownload = function cbDownload(ctx3:amGeneralContext.am_general.A_Context) {
                  if (ctx3 != null && !ctx3.isError()) {
                    const playlistDownloadWell = ctx3.getBoolResult();
                    ...
                    const cbMovePlaylistToDst = function cbMovePlaylistToDst(ctx4: amGeneralContext.am_general.A_Context) {
                      let playlistMoveWell: boolean = true;
                    ...
                    const errorMovePlaylistToDst:amGeneralError.am_general.A_Error       = self._aServiceLocator._iEntityCreation.createDefaultError();   
                    const contextMovePlaylistToDst:amGeneralContext.am_general.A_Context = self._aServiceLocator._iEntityCreation.createDefaultContext();  
                    contextMovePlaylistToDst.setRemoteCallback(true); 
                    self._aDownloadService._iDownloadMain.moveFileAndShaFile(
                      aPlaylistTransferFile.getTmpFileInfo(), aPlaylistTransferFile.getComputedShaFileInfo(), 
                      aPlaylistTransferFile.getDstFileInfo(), aPlaylistTransferFile.getDstShaFileInfo(), 
                      errorMovePlaylistToDst, contextMovePlaylistToDst, cbMovePlaylistToDst);
                  } else {
                    ...
                    self._aActivityLogService._IActivityLogServiceMessaging.addLogMessage(
                      amGeneralActivityLogMessageTypes.am_general.AE_LogMessageTypes.Error, self.getServiceName(),
                      ` - updatePlaylist: downloadPlaylist error ${logMessage}`, null, null, null);
                ...
                const errorDownload:amGeneralError.am_general.A_Error       = self._aServiceLocator._iEntityCreation.createDefaultError();   
                const contextDownload:amGeneralContext.am_general.A_Context = self._aServiceLocator._iEntityCreation.createDefaultContext();  
                contextDownload.setRemoteCallback(true); 
                ...
                self._aActivityLogService._IActivityLogServiceMessaging.addLogMessage(
                  amGeneralActivityLogMessageTypes.am_general.AE_LogMessageTypes.Error, self.getServiceName(),
                  ` - updatePlaylist: cleanupCurrentPlaylist error ${logMessage}`, null, null, null);
            ...
            const errorCleanup:amGeneralError.am_general.A_Error       = self._aServiceLocator._iEntityCreation.createDefaultError();   
            const contextCleanup:amGeneralContext.am_general.A_Context = self._aServiceLocator._iEntityCreation.createDefaultContext();
            contextCleanup.setRemoteCallback(true);
            ...
            self._aActivityLogService._IActivityLogServiceMessaging.addLogMessage(
              amGeneralActivityLogMessageTypes.am_general.AE_LogMessageTypes.Error, self.getServiceName(),
              ` - updatePlaylist: hasNewPlaylist error ${logMessage}`, null, null, null);
        ...
        const errorHasNewPlaylist:amGeneralError.am_general.A_Error       = self._aServiceLocator._iEntityCreation.createDefaultError();   
        const contextHasNewPlaylist:amGeneralContext.am_general.A_Context = self._aServiceLocator._iEntityCreation.createDefaultContext();  
        contextHasNewPlaylist.setRemoteCallback(true); 
        self.hasNewPlaylist(null, aPlaylistTransferFile, null, null, errorHasNewPlaylist, contextHasNewPlaylist, cbHasNewPlaylist);
      }
      
      const errorCreateFolders:amGeneralError.am_general.A_Error         = self._aServiceLocator._iEntityCreation.createDefaultError();   
      const contextCreateFolders:amGeneralContext.am_general.A_Context   = self._aServiceLocator._iEntityCreation.createDefaultContext();  
