import amIPlaylistDownloaderMoodV5 = require("../../../../../app/ts/abstract/am_coreservices/as_playlistdownloader/I_PlaylistDownloaderBuilder_Mood_v5");
...
{
  export class IImpl_PlaylistDownloaderBuilder_Mood_v5 implements  amIPlaylistDownloaderMoodV5.am_coreservices.I_PlaylistDownloaderBuilder_Mood_v5
  {
    _name: string;    
    ...
    //-------------------------------------------
    public existsMediaFile( mediaId: number, contentFileId : number,
                            aPlaylistItemType: amPlaylistItemType.am_coreservices.AE_PlaylistItemType, 
                            mediaFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>,
                            fileTemplayesFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>) : boolean
    ...
    //-------------------------------------------
    public addMediaFile( aPlaylistType: string, 
                         aPlaylistItemType: amPlaylistItemType.am_coreservices.AE_PlaylistItemType, 
                         jsonObject : any, 
                         mediaFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                         ...
                         mediaId: number, contentFileId : number, contentFileName : string, shaFileValue : string, contentPlayerFileName : string, srcFileType: string,
                         bIsHtmlParameter: boolean, 
                         error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback) : number
    {
      ...
      {
         var parentMediaId : number = null;
         var parentContentFileId: number = null;
         var parentContentFileName : string = null;
         var parentShaFileValue : string = null; 
         var parentContentPlayerFileName : string = null;
         this.addHtmlTemplateFile( aPlaylistType, 
                                          aPlaylistItemType, 
                                          jsonObject, 
                                          parentMediaId, parentContentFileId, parentContentFileName, parentShaFileValue, parentContentPlayerFileName,
                                          mediaFilesList, 
                                          fileTemplatesFilesList, 
                                          aPlaylistFileTransfer, 
                                          aMediaFilesFolderTransfer, 
                                          aHtmlTemplatesFilesFolderTransfer, 
                                          //aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
                                          mediaId, contentFileId, contentFileName, shaFileValue, contentPlayerFileName, srcFileType,
                                          bIsHtmlParameter, 
      ...
      if ( this.existsMediaFile(mediaId, contentFileId, aPlaylistItemType, mediaFilesList, fileTemplatesFilesList))
         return 1;
       var newMediaFileTransfer : amGeneralFileTransfer.am_general.AE_FileTransfer = this._owner._aServiceLocator._iEntityCreation.createDefaultFileTransfer(error);
    ...
    //-------------------------------------------
    public existsHtmlTemplateFile( mediaId: number, contentFileId : number,
                                   aPlaylistItemType: amPlaylistItemType.am_coreservices.AE_PlaylistItemType, 
                                   mediaFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>,
                                   fileTemplatesFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>) : boolean
    {
    ...
    //-------------------------------------------
    public addHtmlTemplateFile( aPlaylistType: string, 
                         aPlaylistItemType: amPlaylistItemType.am_coreservices.AE_PlaylistItemType, 
                         jsonObject : any, 
                         parentMediaId: number, parentContentFileId : number, parentContentFileName : string, parentShaFileValue : string, parentContentPlayerFileName : string,
                         mediaFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                         fileTemplatesFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                         aPlaylistFileTransfer     : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                         aMediaFilesFolderTransfer : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                         ...
                         error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback) 
                          : amGeneralFileTransfer.am_general.AE_FileTransfer
    {
      ...
      if (srcFileType != "htmltemplate")    
      {
       ...
       var newHtmlTemplateFileTransfer : amGeneralFileTransfer.am_general.AE_FileTransfer = this._owner._aServiceLocator._iEntityCreation.createDefaultFileTransfer(error);
    ...
    //------------------------------------------
    public addHtmlTemplate_ResourceFile( aPlaylistType: string, 
                         aPlaylistItemType: amPlaylistItemType.am_coreservices.AE_PlaylistItemType, 
                         jsonObject : any, jsonObjectIdx : number,
                         parentMediaId: number, parentContentFileId : number, parentContentFileName : string, parentShaFileValue : string, parentContentPlayerFileName : string,
                         mediaFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                         fileTemplatesFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                         aPlaylistFileTransfer     : amGeneralFileTransfer.am_general.AE_FileTransfer, 
    ...
    */
    ...
    //-------------------------------------------
    public loadMediaFilesList( aPlaylistType: string, jsonObject : any, 
                               mediaFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                               fileTemplatesFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                               aPlaylistFileTransfer     : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                               aMediaFilesFolderTransfer : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                               ...
                               error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
    {
      ...
      */
      //----------------
      this.loadStreams( aPlaylistType, jsonObject, 
                        mediaFilesList, fileTemplatesFilesList,
                        aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, //this._owner._aPlaylist, 
                        error, context, callback);
      /*
      //-------------------
    ...
    //-------------------------------------------------------------------
    public loadStreams( aPlaylistType: string, jsonObject : any, 
                        mediaFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                        fileTemplatesFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                        aPlaylistFileTransfer     : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                        aMediaFilesFolderTransfer : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                        ...
                        error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
    {
      ...
      {
        this.loadOneStream( aPlaylistType, jsonObject.Streams_Extended[iStream], iStream, 
                            mediaFilesList, fileTemplatesFilesList, 
    ...
    //-------------------------------------------------------------------
    public loadOneStream( aPlaylistType: string, jsonObject : any, iStream: number,
                          mediaFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                          fileTemplatesFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                          aPlaylistFileTransfer     : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                          aMediaFilesFolderTransfer : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                          ...
                          error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
    {
      ...
      */
      //--------
      var bIsHtmlParameter: boolean = false;
      //------------------
      this.loadEvents( aPlaylistType, jsonObject.Channel_Extended, 0, 
                       mediaFilesList, fileTemplatesFilesList,
                       aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer,//crtPlaylistStream, 
                       bIsHtmlParameter, error, context, callback);

      //------------------
      this.loadStaticMediaItems( aPlaylistType, jsonObject.Channel_Extended, 
                                 mediaFilesList, fileTemplatesFilesList,
                                 aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, //crtPlaylistStream,  
                                 bIsHtmlParameter, error, context, callback);
      ...
      //------------------
      var iStream = 0;
      this.loadOnePlaylist(aPlaylistType, jsonObject.Channel_Extended.Playlist_Extended, 
                           iStream, 
                           mediaFilesList, fileTemplatesFilesList,
                           aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, //crtPlaylistStream, 
                           bIsHtmlParameter, error, context, callback);
      ...
      //------------------
      this.loadScreenSaver(aPlaylistType, jsonObject.Channel_Extended, 1,
                           mediaFilesList, fileTemplatesFilesList,
                           aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer,//crtPlaylistStream, 
                           bIsHtmlParameter, error, context, callback);
    ...
    //-------------------------------------------------------------------
    public loadScreenSaver( aPlaylistType: string, jsonObject : any, iScreenSaverIdx: number,
                            mediaFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                            fileTemplatesFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                            aPlaylistFileTransfer     : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                            aMediaFilesFolderTransfer : amGeneralFileTransfer.am_general.AE_FileTransfer, 
    ...
    //-------------------------------------------------------------------
    public loadScreenSaverImage( aPlaylistType: string, jsonObject : any, iScreenSaverIdx: number,
                                 mediaFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                                 fileTemplatesFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                                 aPlaylistFileTransfer     : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                                 aMediaFilesFolderTransfer : amGeneralFileTransfer.am_general.AE_FileTransfer, 
    ...
    //-------------------------------------------------------------------
    public loadScreenSaverVideo( aPlaylistType: string, jsonObject : any, iScreenSaverIdx: number,
                                 mediaFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                                 fileTemplatesFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                                 aPlaylistFileTransfer     : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                                 aMediaFilesFolderTransfer : amGeneralFileTransfer.am_general.AE_FileTransfer, 
    ...
    //-------------------------------------------------------------------
    public loadStaticMediaItems( aPlaylistType: string, jsonObject : any, 
                                 mediaFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                                 fileTemplatesFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                                 aPlaylistFileTransfer     : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                                 aMediaFilesFolderTransfer : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                                 ...
                                 error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
    {
       ...
       */
       ...
       {
         this.loadOneMediaItem(aPlaylistType, jsonObject.Medias_Statics_Extended[iMediaItem], iMediaItem, 
                               mediaFilesList, fileTemplatesFilesList,
                               aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer,//crtStaticMediaItems, 
                               bIsHtmlParameter, error, context, callback);
       }
       //-----
    ...
    //-------------------------------------------------------------------
    public loadEvents( aPlaylistType: string, jsonObject : any, iEventsIdx: number,
                       mediaFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                       fileTemplatesFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                       aPlaylistFileTransfer     : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                       aMediaFilesFolderTransfer : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                       ...
                       error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
    {
      ...
      */
      ...
      {
         this.loadOneEvent( aPlaylistType, jsonObject.Events[iEventItem], iEventItem, 
                            mediaFilesList, fileTemplatesFilesList,
                            aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer,//crtItemEvents, 
                            bIsHtmlParameter, error, context, callback);
      }
    ...
    //-------------------------------------------------------------------
    public loadOneEvent( aPlaylistType: string, jsonObject : any, iEventItem: number, 
                         mediaFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                         fileTemplatesFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                         aPlaylistFileTransfer     : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                         aMediaFilesFolderTransfer : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                         ...
                         error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
    {
        ...
        */
        //--------------------
        this.loadMediaItems( aPlaylistType, jsonObject, 
                             mediaFilesList, fileTemplatesFilesList,
                             aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer,//crtItemEvent, 
                             bIsHtmlParameter, error, context, callback);
    ...
    //-------------------------------------------------------------------
    public loadOnePlaylist( aPlaylistType: string, jsonObject : any, iPlaylist: number,
                            mediaFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                            fileTemplatesFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                            aPlaylistFileTransfer     : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                            aMediaFilesFolderTransfer : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                            ...
                            error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
    {
      ...
      */
      ...
      this.loadMediaItems( aPlaylistType, jsonObject, 
                           mediaFilesList, fileTemplatesFilesList,
                           aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer,//crtItemPlaylist,         
                           bIsHtmlParameter, error, context, callback);
      //--------------------
      /*
    ...
    //-------------------------------------------------------------------
    public loadMediaItems( aPlaylistType: string, jsonObject : any, 
                           mediaFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                           fileTemplatesFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                           aPlaylistFileTransfer     : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                           aMediaFilesFolderTransfer : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                           ...
                           error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
    {
      ...
      for (var iMediaItem = 0; iMediaItem < jsonObject.Medias_Extended.length; iMediaItem++) 
      {
         ...
         this.loadOneMediaItem(aPlaylistType, jsonObject.Medias_Extended[iMediaItem], iRealCrtMediaItem, 
                               mediaFilesList, fileTemplatesFilesList,
                               aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer,//aParent, 
                               bIsHtmlParameter, error, context, callback);
         iRealCrtMediaItem++;
   ...
   //-------------------------------------------------------------------
    public loadOneMediaItem( aPlaylistType: string, jsonObject : any, iMediaItem: number,
                             mediaFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                             fileTemplatesFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                             aPlaylistFileTransfer     : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                             aMediaFilesFolderTransfer : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                             ...
                             bIsHtmlParameter: boolean,
                             error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
                             //aHtmlTemplateFileTransfer: amGeneralFileTransfer.am_general.AE_FileTransfer)
    {
      //-------------------
      ...
      switch (jsonMediaTypeId) {
              ...
              case amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.WEBPAGE:
                this.loadOneWebPage(aPlaylistType, jsonObject, iMediaItem, 
                                    mediaFilesList, fileTemplatesFilesList,
                                    aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer,//aParent, 
                                    bIsHtmlParameter, error, context, callback);
                break;
              ...
              case amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.EDITABLE_FLASH:
                this.loadOneEditableFlash(aPlaylistType, jsonObject, iMediaItem, 
                                          mediaFilesList, fileTemplatesFilesList,
                                          aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer,//aParent, 
                                          bIsHtmlParameter, error, context, callback);
                break;
              ...
              case amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.TV_TUNER:
                this.loadOneTvTuner(aPlaylistType, jsonObject, iMediaItem, 
                                    mediaFilesList, fileTemplatesFilesList,
                                    aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer,//aParent, 
                                    bIsHtmlParameter, error, context, callback);
                break;
              ...
              case amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.TV_PASS_THROUGH:
                this.loadOneTvPassThrough(aPlaylistType, jsonObject, iMediaItem, 
                                          mediaFilesList, fileTemplatesFilesList,
                                          aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer,//aParent, 
                                          bIsHtmlParameter, error, context, callback);
                break;
              ...
              case amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.MEDIA_STATIC:
                 this.loadOneImage(aPlaylistType, jsonObject, iMediaItem, 
                                   mediaFilesList, fileTemplatesFilesList,
                                   aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer,//aParent, 
                                   bIsHtmlParameter, error, context, callback);
                 break;
              ...
              case amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.AUDIO_FILES:
                this.loadOneAudioFile(aPlaylistType, jsonObject, iMediaItem, 
                                      mediaFilesList, fileTemplatesFilesList,
                                      aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer,//aParent, 
                                      bIsHtmlParameter, error, context, callback);
                break;
              ...
              case amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.MEDIA_STATIC_MOVIE:
                this.loadOneVideo(aPlaylistType, jsonObject, iMediaItem, 
                                  mediaFilesList, fileTemplatesFilesList,
                                  aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer,//aParent, 
                                  bIsHtmlParameter, error, context, callback);
                break;
              ...
              case amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.HTML_EDITABLE_EXTENDED:
                this.loadOneHtmlTemplate(aPlaylistType, jsonObject, iMediaItem, 
                                         mediaFilesList, fileTemplatesFilesList,
                                         aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer,//aParent, 
                                         bIsHtmlParameter, error, context, callback);
                break;
              ...
              case amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.HTML_FEED:
                this.loadOneHtmlFeed(aPlaylistType, jsonObject, iMediaItem, 
                                     mediaFilesList, fileTemplatesFilesList,
                                     aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer,//aParent, 
                                     bIsHtmlParameter, error, context, callback);
                break;
                ...
                this.loadOneDesign(aPlaylistType, jsonObject, iMediaItem, 
                                   mediaFilesList, fileTemplatesFilesList,
                                   aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer,//aParent, 
                                   bIsHtmlParameter, error, context, callback);
                break;
              ...
              case amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.TAG_EXTENDED:
                this.loadOneTag(aPlaylistType, jsonObject, iMediaItem, 
                                mediaFilesList, fileTemplatesFilesList,
                                aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer,//aParent, 
                                bIsHtmlParameter, error, context, callback);
                break;
              ...
              case amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.FLASH_OBJECT:
                this.loadOneFlash(aPlaylistType, jsonObject, iMediaItem, 
                                  mediaFilesList, fileTemplatesFilesList,
                                  aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer,//aParent, 
                                  bIsHtmlParameter, error, context, callback);
                break;
              ...
              case amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.PLAYLIST:
                this.loadOnePlaylist(aPlaylistType, jsonObject, iMediaItem, 
                                     mediaFilesList, fileTemplatesFilesList,
                                     aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer,//aParent, 
                                     bIsHtmlParameter, error, context, callback);
                break;
              ...
              case amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.VIDEO_OR_AUDIO_STREAM:
                this.loadOneVideoOrAudioStream(aPlaylistType, jsonObject, iMediaItem, 
                                               mediaFilesList, fileTemplatesFilesList,
                                               aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer,//aParent, 
                                               bIsHtmlParameter, error, context, callback);
                break;
...
//-------------------------------------------------------------------
public loadOneImage( aPlaylistType: string, jsonObject : any, iMediaItem: number,
                     mediaFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                     fileTemplatesFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                     aPlaylistFileTransfer     : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                     aMediaFilesFolderTransfer : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                     aHtmlTemplatesFilesFolderTransfer : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                      ...
                      error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
{ 
    this.addMediaFile( aPlaylistType, 
                       ...
                       jsonObject.ID, jsonObject.ContentFileID, jsonObject.ContentFileName, jsonObject.ContentFilePlayerShaCode, jsonObject.ContentPlayerFileName, "bin",
                       bIsHtmlParameter, error, context, callback) ;
...
//-------------------------------------------------------------------
public loadOneVideo( aPlaylistType: string, jsonObject : any, iMediaItem: number,
                     mediaFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                     fileTemplatesFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                     aPlaylistFileTransfer     : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                     aMediaFilesFolderTransfer : amGeneralFileTransfer.am_general.AE_FileTransfer, 
...
//-------------------------------------------------------------------
public loadOneWebPage( aPlaylistType: string, jsonObject : any, iMediaItem: number,
                       mediaFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                       fileTemplatesFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                       aPlaylistFileTransfer     : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                       aMediaFilesFolderTransfer : amGeneralFileTransfer.am_general.AE_FileTransfer, 
...
//-------------------------------------------------------------------
public loadOneHtmlTemplate( aPlaylistType: string, jsonObject : any, iMediaItem: number,
                            mediaFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                            fileTemplatesFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                            aPlaylistFileTransfer     : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                            aMediaFilesFolderTransfer : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                            ...
                            error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
{
  var aParentHtmlTemplateFileTransfer: amGeneralFileTransfer.am_general.AE_FileTransfer = 
          this.addHtmlTemplateFile( aPlaylistType, 
                     amPlaylistItemType.am_coreservices.AE_PlaylistItemType.PlaylistItemType_HtmlTemplate,
                     jsonObject, 
                     jsonObject.ID, jsonObject.ContentFileID, jsonObject.ContentFileName, jsonObject.ContentFilePlayerShaCode, jsonObject.ContentPlayerFileName,
                     mediaFilesList, fileTemplatesFilesList,
                     aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer,
                     jsonObject.ID, jsonObject.ContentFileID, jsonObject.ContentFileName, jsonObject.ContentFilePlayerShaCode, jsonObject.ContentPlayerFileName, "htmltemplate",
                     bIsHtmlParameter, error, context, callback) ;
  ...
  try 
  {
    ...
    {
      //-------------------------------------------------------------------
      this.loadOneMediaItem( aPlaylistType, jsonObject.HtmlParameters_Extended[j], j,
                             mediaFilesList, 
                             fileTemplatesFilesList, 
                             aPlaylistFileTransfer, 
                             aMediaFilesFolderTransfer, 
    ...
    */
    ...
    { 
      this.addHtmlTemplate_ResourceFile( 
                      aPlaylistType, 
                      amPlaylistItemType.am_coreservices.AE_PlaylistItemType.PlaylistItemType_HtmlTemplateResource,
                      jsonObject.Html_Template_Resources[k], k,
                      jsonObject.ID, jsonObject.ContentFileID, jsonObject.ContentFileName, jsonObject.ContentFilePlayerShaCode, jsonObject.ContentPlayerFileName,
                      mediaFilesList, 
                      fileTemplatesFilesList, 
                      aPlaylistFileTransfer, 
...
//-------------------------------------------------------------------
public loadOneHtmlFeed( aPlaylistType: string, jsonObject : any, iMediaItem: number,
                        mediaFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                        fileTemplatesFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                        aPlaylistFileTransfer     : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                        aMediaFilesFolderTransfer : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                       ...
                       error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
{
   ...
   {
     this.addMediaFile( aPlaylistType, 
                        amPlaylistItemType.am_coreservices.AE_PlaylistItemType.PlaylistItemType_HtmlFeed,
                        jsonObject, 
                        mediaFilesList, fileTemplatesFilesList,
                        aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer,
                        jsonObject.ID, jsonObject.ContentFileID, jsonObject.ContentFileName, jsonObject.ContentFilePlayerShaCode, jsonObject.ContentPlayerFileName, "htmlfeed",
                        bIsHtmlParameter, error, context, callback) ;
...
//-------------------------------------------------------------------
public loadOneDesign( aPlaylistType: string, jsonObject : any, iMediaItem: number,
                      mediaFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                      fileTemplatesFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                      aPlaylistFileTransfer     : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                      aMediaFilesFolderTransfer : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                      ...
                      error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
{
  ...
  */
  //--------------------
  this.loadDesignZones( aPlaylistType, jsonObject, 
                        mediaFilesList, fileTemplatesFilesList,
                        aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer,//crtPlaylistItemDesign, 
                        bIsHtmlParameter, error, context, callback);  
  //--------------------  
  //--------------------
...
//-------------------------------------------------------------------
public loadDesignZones( aPlaylistType: string, jsonObject : any, 
                        mediaFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                        fileTemplatesFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                        aPlaylistFileTransfer     : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                        aMediaFilesFolderTransfer : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                        ...
                        error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
{
  ...
  {
    this.loadOneDesignZone( aPlaylistType, jsonObject.Zones_Extended[iDesignZone], iDesignZone, 
                            mediaFilesList, fileTemplatesFilesList,
                            aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer,//aParent, 
                            bIsHtmlParameter, error, context, callback);
  }
...
//-------------------------------------------------------------------
public loadOneDesignZone( aPlaylistType: string, jsonObject : any, iDesignZone: number,
                          mediaFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                          fileTemplatesFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                          aPlaylistFileTransfer     : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                          aMediaFilesFolderTransfer : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                          ...
                          error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
{
   ...
   */
  //--------------------
  this.loadOnePlaylist( aPlaylistType, jsonObject.Playlist_Extended, 0, 
                        mediaFilesList, fileTemplatesFilesList,
                        aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer,//crtPlaylistItemDesignZone, 
                        bIsHtmlParameter, error, context, callback);  
...
//-------------------------------------------------------------------
public loadOneFillRect( aPlaylistType: string, jsonObject : any, iFillRectIdx: number,
                        mediaFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                        fileTemplatesFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                        aPlaylistFileTransfer     : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                        aMediaFilesFolderTransfer : amGeneralFileTransfer.am_general.AE_FileTransfer, 
...
//-------------------------------------------------------------------
public loadOneTag( aPlaylistType: string, jsonObject : any, iMediaItem: number,
                   mediaFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                   fileTemplatesFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                   aPlaylistFileTransfer     : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                   aMediaFilesFolderTransfer : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                                  ...
                                  error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
{
  ...
  for (var iTagMediaId = 0; iTagMediaId < jsonTagObject.MEDIA_IDS.length; iTagMediaId++) 
  {
    ...
    if (iJsonStaticMediaIdx == -1)
      continue;
    this.loadOneMediaItem(aPlaylistType, jsonStaticMedias[iJsonStaticMediaIdx], iTagMediaId, 
                          mediaFilesList, fileTemplatesFilesList,
                          aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, //aParent, 
                          bIsHtmlParameter, error, context, callback);
  }
...
//-------------------------------------------------------------------
public createOrGeAndSetRealTag( nbChildren: number, aPlaylistType: string, jsonObject : any, 
                                mediaFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                                fileTemplatesFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                                aPlaylistFileTransfer     : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                                aMediaFilesFolderTransfer : amGeneralFileTransfer.am_general.AE_FileTransfer, 
...
//-------------------------------------------------------------------
public loadOneEditableFlash( aPlaylistType: string, jsonObject : any, iMediaItem: number,
                             mediaFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                             fileTemplatesFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                             aPlaylistFileTransfer     : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                             aMediaFilesFolderTransfer : amGeneralFileTransfer.am_general.AE_FileTransfer, 
...
//-------------------------------------------------------------------
public loadOneTvTuner( aPlaylistType: string, jsonObject : any, iMediaItem: number,
                       mediaFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                       fileTemplatesFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                       aPlaylistFileTransfer     : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                       aMediaFilesFolderTransfer : amGeneralFileTransfer.am_general.AE_FileTransfer, 
...
//-------------------------------------------------------------------
public loadOneTvPassThrough( aPlaylistType: string, jsonObject : any, iMediaItem: number,
                             mediaFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                             fileTemplatesFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                             aPlaylistFileTransfer     : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                             aMediaFilesFolderTransfer : amGeneralFileTransfer.am_general.AE_FileTransfer, 
...
//-------------------------------------------------------------------
public loadOneAudioFile( aPlaylistType: string, jsonObject : any, iMediaItem: number,
                         mediaFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                         fileTemplatesFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                         aPlaylistFileTransfer     : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                         aMediaFilesFolderTransfer : amGeneralFileTransfer.am_general.AE_FileTransfer, 
...
//-------------------------------------------------------------------
public loadOneFlash( aPlaylistType: string, jsonObject : any, iMediaItem: number,
                     mediaFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                     fileTemplayesFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                     aPlaylistFileTransfer     : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                     aMediaFilesFolderTransfer : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                     aHtmlTemplatesFilesFolderTransfer : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                     //aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
...
//-------------------------------------------------------------------
public loadOnePlaylist2( aPlaylistType: string, jsonObject : any, iMediaItem: number,
                         mediaFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                         fileTemplatesFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                         aPlaylistFileTransfer     : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                         aMediaFilesFolderTransfer : amGeneralFileTransfer.am_general.AE_FileTransfer, 
...
//-------------------------------------------------------------------
public loadOneVideoOrAudioStream( aPlaylistType: string, jsonObject : any, iMediaItem: number,
                                  mediaFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                                  fileTemplatesFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                                  aPlaylistFileTransfer     : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                                  aMediaFilesFolderTransfer : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                                  ...
                                  error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback)
{
  ...
  if (jsonObject.Properties.Type == "VIDEO")
    return this.loadOneVideoStream( aPlaylistType, jsonObject, iMediaItem, 
                                    mediaFilesList, fileTemplatesFilesList,
                                    aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, //aParent, 
                                    bIsHtmlParameter, error, context, callback);
  if (jsonObject.Properties.Type == "AUDIO")
    return this.loadOneAudioStream( aPlaylistType, jsonObject, iMediaItem, 
                                    mediaFilesList, fileTemplatesFilesList,
                                    aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, //aParent, 
                                    bIsHtmlParameter, error, context, callback);
...
//-------------------------------------------------------------------
public loadOneVideoStream( aPlaylistType: string, jsonObject : any, iMediaItem: number,
                           mediaFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                           fileTemplatesFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                           aPlaylistFileTransfer     : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                           aMediaFilesFolderTransfer : amGeneralFileTransfer.am_general.AE_FileTransfer, 
...
//-------------------------------------------------------------------
public loadOneAudioStream( aPlaylistType: string, jsonObject : any, iMediaItem: number,
                           mediaFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                           fileTemplatesFilesList: Map<number, amGeneralFileTransfer.am_general.AE_FileTransfer>, 
                           aPlaylistFileTransfer     : amGeneralFileTransfer.am_general.AE_FileTransfer, 
                           aMediaFilesFolderTransfer : amGeneralFileTransfer.am_general.AE_FileTransfer, 
