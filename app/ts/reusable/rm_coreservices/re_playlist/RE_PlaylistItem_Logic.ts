...
export module rm_coreservices
{
                                     ...
                                     implements amCoreServices.am_coreservices.AE_PlaylistItem_Logic
  {
    ...
    _canReuseAlreadyCreatedRenderingZone : boolean;
    _canDestroyAlreadyCreatedRenderingZone : boolean;
    ...
    _aSDKService : amTransversalServicesSDKJsTV.am_transversalservices.A_SDK_JsTV;
    ...
    constructor()
    {
      ...
      this._canDestroyAlreadyCreatedRenderingZone = false;
    ...
    //----------------------------------------
    public setCanDestroyAlreadyCreatedRenderingZone(canDestroyAlreadyCreatedRenderingZone: boolean)
    {
    ...
    //=========================
    public extract_one_or_two_digits_before_char(strDuration : string, strChar : string) : string
    {
      if (strDuration == null)
        return "0";
      if (strDuration == "")
    ...
    public parseJsonDuration(strDuration) : Date
    {
      ...
      var self = this;
      try{
        let dtDate = self.getSDKGoodCrtDate();//new Date(); //ma2 // creates a Date Object using the clients current time
    ...
    //=========================
    //"PT23H59M59S"
    public parseJsonDuration_prev(strDuration) : Date
    {
      if (strDuration == null)
        return null;
      try{
        ...
        let dtDate = this.getSDKGoodCrtDate();//new Date(); //ma2 // creates a Date Object using the clients current time
                                       ...
                                       context: amGeneralContext.am_general.A_Context, callback): boolean
   {
    ...
    // shutdown
    //================================
    public shutdown(  error: amGeneralError.am_general.A_Error, 
                      context: amGeneralContext.am_general.A_Context, callback) : number
    {
