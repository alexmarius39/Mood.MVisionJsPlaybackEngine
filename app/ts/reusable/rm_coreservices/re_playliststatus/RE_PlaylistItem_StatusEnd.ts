                                           ...
                                           context: amGeneralContext.am_general.A_Context, callback): void
    {
      //try {
        ...
        if (this.getDiagram().mustCreateARenderingZone())
        {
          ...
          if (! this.getDiagram().canReuseAlreadyCreatedRenderingZone())
          {

            this.trace(1,"plc_trace", " START ", " CREATE RENDERING ZONE ");
            console.log("===================  CREATE RENDERING ZONE " + zoneId);
            ...
            //console.log("===================  NOT CREATE RENDERING ZONE " + zoneId);
          }          
        }
      //}catch(e){
      //}
                                           ...
                                           context: amGeneralContext.am_general.A_Context, callback): void
    {
      ...
      //{
        if (this.getDiagram() != null)
        {
          ...
          if (this.getDiagram().mustCreateARenderingZone())
          {
            if (! this.getDiagram().canDestroyAlreadyCreatedRenderingZone())
            {
              this.trace(1,"plc_trace", " STOP ", " DESTROY RENDERING ZONE ");
              var owner = this;
              
              console.log("===================  DESTROY RENDERING ZONE " + zoneId);
            ...
            //console.log("===================  NOT DESTROY RENDERING ZONE " + zoneId);
          }
        }
        context.setError(error);
        if (callback != null)
