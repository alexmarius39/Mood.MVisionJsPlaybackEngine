...
{
  export class R_SDK_Client   extends rmTransversalServicesSDKJsTV.rm_transversalservices.R_SDK_JsTV // extends rmGeneralService.rm_general.R_Service 
                              implements amTransversalServices.am_transversalservices.A_SDK_JsTV
  {
    ...
    {      
      ...
      this._service_name          = "R_SDK_Client";
