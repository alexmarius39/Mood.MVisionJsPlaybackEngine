...
export module rm_transversalservices
{
  export class IImpl_SDK_notifyFileSystem_SDKConnector implements amGeneral.am_transversalservices.I_SDK_notifyFileSystem
  {
    ...
    public notify_readBinaryFile(storageName: string, folderName: string, fileName: string, error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback): void 
    {
      this._owner._aSDKConsumer._iNotify_SDKFileSystem.notify_readBinaryFile(storageName, folderName, fileName, error, context, callback); 
    }
  ...
  //--------------------------------------
    ...
    //----------------------------
    public notify_getLastModified(aFileInfo:amGeneralFileInfo.am_general.A_FileInfo, error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback) : void 
    {
      this._owner._aSDKConsumer._iNotify_SDKFileSystem.notify_getLastModified(aFileInfo, error, context, callback); 
    }
