...
export module rm_transversalservices
{
  export class IImpl_SDK_notifyFirmwareSetup_SDKConnector implements amGeneral.am_transversalservices.I_SDK_notifyFirmwareSetup
  {
    ...
    public notify_getFirmwareVersion(error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback) : void
    {
      this._owner._aSDKConsumer._iNotify_SDKFirmwareSetup.notify_getFirmwareVersion(error, context, callback);
    }

    public notify_promise_getFirmwareVersion(error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback) : void
    {
