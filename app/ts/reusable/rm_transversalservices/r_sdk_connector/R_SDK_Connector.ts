...
{
  export class R_SDK_Connector   extends rmTransversalServicesSDKJsTV.rm_transversalservices.R_SDK_JsTV //extends rmGeneralService.rm_general.R_Service 
                                            ...
                                            amTransversalServicesSDKConsumer.am_transversalservices.A_SDK_Consumer
  {
    ...
    {      
      ...
      this._service_name          = "R_SDK_Connector";
