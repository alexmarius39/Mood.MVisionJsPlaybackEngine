...
export module rm_transversalservices
{
  export class IImpl_SDK_notifyFileSystem_SDKConsumer implements amGeneral.am_transversalservices.I_SDK_notifyFileSystem
  {
    ...
    public notify_readBinaryFile(storageName: string, folderName: string, fileName: string, error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback) 
    {
