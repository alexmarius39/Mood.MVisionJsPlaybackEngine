...
export module rm_transversalservices
{
  export class IImpl_Utils_DateTime_R implements amTransversalServices.am_transversalservices.I_UtilsService
  {
    ...
    public getCrtDateTimeAsString2(formatDate: string, formatTime: string, separator: string = "") : string
    {
      var strDate ="";
      var strTime ="";
      try{
      ...
      const crtMonth: number = crtDate.getMonth() + 1;
      var strMonth = "" + crtMonth; // getMonth() returns value from range [0-11]
      if ( crtMonth < 10)
        strMonth = "0"+ strMonth;  
      ...
      if (formatTime == "hh:mm:ss")  
        ...
        strTime = strHours + ":" + strMinutes ;
      else if (formatTime == "HH:mm:ss.SSS") {
        strTime = strHours + ":" + strMinutes + ":" + strSeconds + "." + strMs;
      }
      return strDate + separator + strTime;
    }
    ...
    //----------------------------------------------------------------------
    public getDateTime(aDateTime: amGeneralDateTime.am_general.A_DateTime, strDate: string) : void
    {
    ...
    //------------------------------------
    public getCrtDateTimeAsISOString(aDateTime: amGeneralDateTime.am_general.A_DateTime) : string
    {
      var now = new Date();
      aDateTime.setDateTime(now.getFullYear(), now.getMonth()+1, now.getDate(), now.getHours(), now.getMinutes(), now.getSeconds(), now.getMilliseconds() );
      return aDateTime.getAsISOString();
    }

    //------------------------------------
    public getDateTimeAsISOString(aDateTime: amGeneralDateTime.am_general.A_DateTime, strDate: string) : string
    {
      var now = new Date(strDate);
      aDateTime.setDateTime(now.getFullYear(), now.getMonth()+1, now.getDate(), now.getHours(), now.getMinutes(), now.getSeconds(), now.getMilliseconds() );
      return aDateTime.getAsISOString();
    ...
    //------------------------------------
    public getCrtDateTimeAsISOString2() : string
    {
      var now = new Date();
    ...
    //----------------------------------------------------------------------
    public getCrtUTCDateTimeAsISOString(aDateTime: amGeneralDateTime.am_general.A_DateTime) : string
    {
      var now = new Date();
      aDateTime.setDateTime(now.getUTCFullYear(), now.getUTCMonth()+1, now.getUTCDate(), now.getUTCHours(), now.getUTCMinutes(), now.getUTCSeconds(), now.getUTCMilliseconds());
      return aDateTime.getAsISOString();
