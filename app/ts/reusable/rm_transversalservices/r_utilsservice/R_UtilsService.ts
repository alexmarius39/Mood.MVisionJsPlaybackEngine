...
import amTransversalServicesIUtilsSignalR   = require("../../../../../app/ts/abstract/am_transversalservices/a_utilsservice/I_Utils_SignalR");
...
import rmTransversalServicesIUtilsSignalR   = require("../../../../../app/ts/reusable/rm_transversalservices/r_utilsservice/IImpl_Utils_SignalR_R");
...
export module rm_transversalservices
{
                              ...
                              implements amTransversalServices.am_transversalservices.A_UtilsService
  {
    ...
    _iUtilsSignalR   : amTransversalServicesIUtilsSignalR.am_transversalservices.I_Utils_SignalR ;
    ...
    {      
      ...
      this._iUtilsSignalR   = new rmTransversalServicesIUtilsSignalR.rm_transversalservices.IImpl_Utils_SignalR_R(this) ;
    }
