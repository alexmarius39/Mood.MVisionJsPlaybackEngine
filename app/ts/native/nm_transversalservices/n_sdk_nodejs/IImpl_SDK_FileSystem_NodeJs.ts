                                            ...
                                            implements amGeneral.am_transversalservices.I_SDK_FileSystem
  {
      ...
      if (fs != null && typeof fs.readFile === "function" && fileFullName != null) {
        fs.readFile(fileFullName, null, function(err, data) {
          if (err != null) {
            ...
            let bufView: Uint8Array = new Uint8Array(data);
                          ...
                          error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback) : void 
    {
      ...
      try{
        ...
        var options = {
          url: remoteUrlName,
          method: 'GET', //'POST', // Don't forget this line
          headers: {
      ...
      if (fs != null && typeof fs.stat === "function" && fullName != null) {
        fs.stat(fullName, function(err, stats) {
          if (err == null && stats != null && 
            ...
            const errStr: string = err ? err.message : "not a file or directory";
