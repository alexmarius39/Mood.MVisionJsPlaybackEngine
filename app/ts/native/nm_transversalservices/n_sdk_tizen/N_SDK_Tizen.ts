...
{
  export class N_SDK_Tizen   extends rmTransversalServicesSDKJsTV.rm_transversalservices.R_SDK_JsTV //extends rmGeneralService.rm_general.R_Service 
                             implements amTransversalServices.am_transversalservices.A_SDK_JsTV
  {
    ...
    {      
      ...
      this._service_name          = "N_SDK_Tizen";
