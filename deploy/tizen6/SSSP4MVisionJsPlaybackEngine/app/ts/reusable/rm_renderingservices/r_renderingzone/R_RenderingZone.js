...
define(["require", "exports", "../../../abstract/am_general/a_activitylogservicesettings/AE_ActivityLogMessageTypes", "../../../../../app/ts/abstract/am_renderingservices/ae_renderparams/AE_RenderParams_MediaTypeEnum", "../../../../../app/ts/abstract/am_renderingservices/ae_renderparams/AE_RenderParams_MediaItemStatus", "../../../../../app/ts/reusable/rm_renderingservices/r_renderingservice/R_RenderingService", "../../../../../app/ts/reusable/rm_renderingservices/r_renderingzone/IImpl_RenderingZone_R", "../../../../../app/ts/reusable/rm_renderingservices/r_renderingzone/IImpl_RenderingZone_Config"], function (require, exports, amGeneralActivityLogMessageTypes, amMediaTypeEnum, amMediaItemStatus, rmRenderingServices, rmIRenderingZone, rmIRenderingZoneConfig) {
    "use strict";
    ...
    (function (rm_renderingservices) {
        var R_RenderingZone = /** @class */ (function (_super) {
            ...
            R_RenderingZone.prototype.setActivityLogService = function (aActivityLogService) {
                this._aActivityLogService = aActivityLogService;
            };
            //-----------------------------
            R_RenderingZone.prototype.getActivityLogService = function () {
            ...
            R_RenderingZone.prototype._prepareNextMediaItem = function (prepareIndex, prepareParams, error, context, callback) {
                ...
                if (this.getPrepareParams(prepareIndex).getRenderParams().getParamIdentification().getMediaType() == amMediaTypeEnum.am_renderingservices.AE_RenderParams_MediaTypeEnum.MediaType_Image) {
                    ...
                    owner._aActivityLogService._IActivityLogServiceMessaging.addLogMessage(amGeneralActivityLogMessageTypes.am_general.AE_LogMessageTypes.Info, owner.getServiceName(), "  Start IMAGE - " +
                        " zoneId: " + owner._zoneId +
                        " mediaId: " + owner.getPrepareParams(prepareIndex).getRenderParams().getParamIdentification().getId() +
                        " mediaName: " + owner.getPrepareParams(prepareIndex).getRenderParams().getParamIdentification().getName(), null, null, null);
                ...
                if (this.getPrepareParams(prepareIndex).getRenderParams().getParamIdentification().getMediaType() == amMediaTypeEnum.am_renderingservices.AE_RenderParams_MediaTypeEnum.MediaType_Video) {
                    ...
                    owner._aActivityLogService._IActivityLogServiceMessaging.addLogMessage(amGeneralActivityLogMessageTypes.am_general.AE_LogMessageTypes.Info, owner.getServiceName(), "  Start VIDEO - " +
                        " zoneId: " + owner._zoneId +
                        " mediaId: " + owner.getPrepareParams(prepareIndex).getRenderParams().getParamIdentification().getId() +
                        " mediaName: " + owner.getPrepareParams(prepareIndex).getRenderParams().getParamIdentification().getName(), null, null, null);
                ...
                if (this.getPrepareParams(prepareIndex).getRenderParams().getParamIdentification().getMediaType() == amMediaTypeEnum.am_renderingservices.AE_RenderParams_MediaTypeEnum.MediaType_Html) {
                    ...
                    if (this.getPrepareParams(prepareIndex).getRenderParams().getParamHtmlTemplate().getIsHtmlTemplate()) {
                        owner._aActivityLogService._IActivityLogServiceMessaging.addLogMessage(amGeneralActivityLogMessageTypes.am_general.AE_LogMessageTypes.Info, owner.getServiceName(), "  Start HTML TEMPLATE - " +
                            " zoneId: " + owner._zoneId +
                            " mediaId: " + owner.getPrepareParams(prepareIndex).getRenderParams().getParamIdentification().getId() +
                            " mediaName: " + owner.getPrepareParams(prepareIndex).getRenderParams().getParamIdentification().getName(), null, null, null);
                    }
                    else {
                        owner._aActivityLogService._IActivityLogServiceMessaging.addLogMessage(amGeneralActivityLogMessageTypes.am_general.AE_LogMessageTypes.Info, owner.getServiceName(), "  Start HTML PAGE - " +
                            " zoneId: " + owner._zoneId +
                            " mediaId: " + owner.getPrepareParams(prepareIndex).getRenderParams().getParamIdentification().getId() +
                            " mediaName: " + owner.getPrepareParams(prepareIndex).getRenderParams().getParamIdentification().getName(), null, null, null);
                    }
                ...
                if (this.getPrepareParams(prepareIndex).getRenderParams().getParamIdentification().getMediaType() == amMediaTypeEnum.am_renderingservices.AE_RenderParams_MediaTypeEnum.MediaType_ScreenSaver) {
                    ...
                    owner._aActivityLogService._IActivityLogServiceMessaging.addLogMessage(amGeneralActivityLogMessageTypes.am_general.AE_LogMessageTypes.Info, owner.getServiceName(), "  Start Screen Saver - " +
                        " zoneId: " + owner._zoneId +
                        " mediaId: " + owner.getPrepareParams(prepareIndex).getRenderParams().getParamIdentification().getId() +
                        " mediaName: " + owner.getPrepareParams(prepareIndex).getRenderParams().getParamIdentification().getName(), null, null, null);
            ...
            R_RenderingZone.prototype._stopCrtMediaItem = function (runIndex, stopParams, error, context, callback) {
                ...
                if (this.getPrepareParams(runIndex).getRenderParams().getParamIdentification().getMediaType() == amMediaTypeEnum.am_renderingservices.AE_RenderParams_MediaTypeEnum.MediaType_Image) {
                    owner._aActivityLogService._IActivityLogServiceMessaging.addLogMessage(amGeneralActivityLogMessageTypes.am_general.AE_LogMessageTypes.Info, owner.getServiceName(), "  Stop IMAGE - " +
                        " zoneId: " + owner._zoneId +
                        " mediaId:" + owner.getPrepareParams(runIndex).getRenderParams().getParamIdentification().getId() +
                        " mediaName: " + owner.getPrepareParams(runIndex).getRenderParams().getParamIdentification().getName(), null, null, null);
                ...
                if (this.getPrepareParams(runIndex).getRenderParams().getParamIdentification().getMediaType() == amMediaTypeEnum.am_renderingservices.AE_RenderParams_MediaTypeEnum.MediaType_Video) {
                    owner._aActivityLogService._IActivityLogServiceMessaging.addLogMessage(amGeneralActivityLogMessageTypes.am_general.AE_LogMessageTypes.Info, owner.getServiceName(), "  Stop Video Renderer - " +
                        " zoneId: " + owner._zoneId +
                        " mediaId:" + owner.getPrepareParams(runIndex).getRenderParams().getParamIdentification().getId() +
                        " mediaName: " + owner.getPrepareParams(runIndex).getRenderParams().getParamIdentification().getName(), null, null, null);
                ...
                if (this.getPrepareParams(runIndex).getRenderParams().getParamIdentification().getMediaType() == amMediaTypeEnum.am_renderingservices.AE_RenderParams_MediaTypeEnum.MediaType_Html) {
                    if (this.getPrepareParams(runIndex).getRenderParams().getParamHtmlTemplate().getIsHtmlTemplate()) {
                        owner._aActivityLogService._IActivityLogServiceMessaging.addLogMessage(amGeneralActivityLogMessageTypes.am_general.AE_LogMessageTypes.Info, owner.getServiceName(), "  Stop HTML Template - " +
                            " zoneId: " + owner._zoneId +
                            " mediaId:" + owner.getPrepareParams(runIndex).getRenderParams().getParamIdentification().getId() +
                            " mediaName: " + owner.getPrepareParams(runIndex).getRenderParams().getParamIdentification().getName(), null, null, null);
                    }
                    else {
                        owner._aActivityLogService._IActivityLogServiceMessaging.addLogMessage(amGeneralActivityLogMessageTypes.am_general.AE_LogMessageTypes.Info, owner.getServiceName(), "  Stop HTML Page - " +
                            " zoneId: " + owner._zoneId +
                            " mediaId:" + owner.getPrepareParams(runIndex).getRenderParams().getParamIdentification().getId() +
                            " mediaName: " + owner.getPrepareParams(runIndex).getRenderParams().getParamIdentification().getName(), null, null, null);
                    }
                ...
                if (this.getPrepareParams(runIndex).getRenderParams().getParamIdentification().getMediaType() == amMediaTypeEnum.am_renderingservices.AE_RenderParams_MediaTypeEnum.MediaType_ScreenSaver) {
                    owner._aActivityLogService._IActivityLogServiceMessaging.addLogMessage(amGeneralActivityLogMessageTypes.am_general.AE_LogMessageTypes.Info, owner.getServiceName(), "  Stop Screen Saver - " +
                        " zoneId: " + owner._zoneId +
                        " mediaId:" + owner.getPrepareParams(runIndex).getRenderParams().getParamIdentification().getId() +
                        " mediaName: " + owner.getPrepareParams(runIndex).getRenderParams().getParamIdentification().getName(), null, null, null);
