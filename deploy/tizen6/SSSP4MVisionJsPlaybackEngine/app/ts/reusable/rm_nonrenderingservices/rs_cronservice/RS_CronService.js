...
define(["require", "exports", "../../../../../app/ts/abstract/am_general/ae_scheduletype/AE_ScheduleType", "../../../../../app/ts/abstract/am_general/ae_serviceconstrainttype/AE_ServiceConstraintType", "../../../../../app/ts/abstract/am_general/a_activitylogservicesettings/AE_ActivityLogMessageTypes", "../../../../../app/ts/reusable/rm_nonrenderingservices/r_nonrenderingservice/R_NonRenderingService", "../../../../../app/ts/reusable/rm_nonrenderingservices/rs_cronservice/RI_CronServiceMain", "../../../../../app/ts/reusable/rm_nonrenderingservices/rs_cronservice/RI_CronServiceConfig"], function (require, exports, amGeneralScheduleType, amServiceConstraintType, amGeneralActivityLogMessageTypes, rmNonRenderingServices, rmICronServiceMain, rmICronServiceConfig) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    //=========================================================================================================
    var rm_nonrenderingservices;
    (function (rm_nonrenderingservices) {
        var RS_CronService = /** @class */ (function (_super) {
            ...
            RS_CronService.prototype.start_one_cron_schedule = function (aCronSchedule, error, context, callback) {
                ...
                if ((aCronSchedule.getScheduleInfo().getScheduleType() == amGeneralScheduleType.am_general.AE_ScheduleType.ScheduleType_Daily)
                    ...
                    || (aCronSchedule.getScheduleInfo().getScheduleType() == amGeneralScheduleType.am_general.AE_ScheduleType.ScheduleType_Once)) //am .ScheduleType_None)
                 {
                    //--------------------------------
            ...
            RS_CronService.prototype.schedule_midnight_timer = function (error, context, callback) {
                ...
                var scheduleTime = new Date(crtTime.getFullYear(), crtTime.getMonth(), crtTime.getDate() + 1, // the next day, ...
                0, 0, 1);
                var self = this;
            ...
            RS_CronService.prototype.daily_schedule_must_start = function (crtCronSchedule, error, context, callback) {
                ...
                var crtTime = new Date();
                var scheduleTime = new Date(crtTime.getFullYear(), crtTime.getMonth(), crtTime.getDate(), // the next day, ...
                iAtHour, iAtMinute, iAtSecond);
                var msTillScheduleInMilSec = scheduleTime.getTime() - crtTime.getTime();
            ...
            RS_CronService.prototype.start_all_daily_weekly_monthly_cron_schedules = function (aCronScheduleList, bAtStartupDaySchedule, error, context, callback) {
                ...
                var callbackOneCronSchedule = function callbackOneCronSchedule(crtScheduleIdx, ctx1) {
                    ...
                    if ((crtCronSchedule.getScheduleInfo().getScheduleType() == amGeneralScheduleType.am_general.AE_ScheduleType.ScheduleType_Daily)
                        ...
                        || (crtCronSchedule.getScheduleInfo().getScheduleType() == amGeneralScheduleType.am_general.AE_ScheduleType.ScheduleType_Once)) //am .ScheduleType_None)
                     {
