...
define(["require", "exports", "../../../../../app/ts/reusable/rm_general/r_entity/R_Entity"], function (require, exports, rmGeneralEntity) {
    ...
    (function (rm_general) {
        var R_FileInfo = /** @class */ (function (_super) {
            ...
            R_FileInfo.prototype.copyFromJson = function (jsonFileInfo) {
                if (jsonFileInfo != null) {
                    this._fileName = jsonFileInfo._fileName;
                    this._path = jsonFileInfo._path;
                    this._storage = jsonFileInfo._storage;
                    this._type = jsonFileInfo._type;
                    this._size = jsonFileInfo._size;
                    this._creationDate = jsonFileInfo._creationDate;
                    this._lastModifiedDate = jsonFileInfo._lastModifiedDate;
                    this._lastAccessedDate = jsonFileInfo._lastAccessedDate;
                    this._urlFileName = jsonFileInfo._urlFileName;
                    this._urlPath = jsonFileInfo._urlPath;
                    this._urlStorage = jsonFileInfo._urlStorage;
                }
            };
            //-------------------------------------
