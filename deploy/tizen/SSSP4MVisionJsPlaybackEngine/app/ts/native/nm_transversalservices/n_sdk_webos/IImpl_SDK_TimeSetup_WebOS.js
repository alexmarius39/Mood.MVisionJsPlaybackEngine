define(["require", "exports", "./cordova/cordova.webos", "./cordova/configuration", "./cordova/time"], function (require, exports) {
    ...
    (function (nm_transversalservices) {
        var IImpl_SDK_TimeSetup_WebOS = /** @class */ (function () {
            ...
            //--------------------
            IImpl_SDK_TimeSetup_WebOS.prototype.setTimeConvertor = function (aTimeZoneConvertor) {
            };
            //--------------------
            IImpl_SDK_TimeSetup_WebOS.prototype.setNTPServer = function (strServerUrl, error, context, callback) {
                context != null && context.setError(error);
                callback != null && callback(context);
            };
            IImpl_SDK_TimeSetup_WebOS.prototype.getNTPServer = function (error, context, callback) {
                if (context != null) {
                    context.setResult("");
            ...
            IImpl_SDK_TimeSetup_WebOS.prototype.setUseNTP = function (bUse, error, context, callback) {
                context.setError(error);
                callback != null && callback(context);
            };
            IImpl_SDK_TimeSetup_WebOS.prototype.getUseNTP = function (error, context, callback) {
                context.setError(error);
                callback != null && callback(context);
            };
            //---------------------------------------
            ...
            //--------------------
            IImpl_SDK_TimeSetup_WebOS.prototype.getGoodCrtDateTime = function (error, context, callback) {
                return this._owner.getGoodCrtDateTime(error, context, callback);
            };
            //--------------------
            IImpl_SDK_TimeSetup_WebOS.prototype.getSyncGoodCrtDateTime = function (error, context) {
            ...
            //-----------------------------
            IImpl_SDK_TimeSetup_WebOS.prototype.getTimeZoneOffset = function (aTimeZone, error, context, callback) {
            };
            //--------------------------------
