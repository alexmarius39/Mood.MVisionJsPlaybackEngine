define(["require", "exports", "./cordova/cordova.webos", "./cordova/storage", "./cordova/deviceInfo"], function (require, exports) {
    ...
    (function (nm_transversalservices) {
        var IImpl_SDK_HardwareSetup_WebOS = /** @class */ (function () {
            ...
            IImpl_SDK_HardwareSetup_WebOS.prototype.getCPUInfo = function (error, context, callback) {
            };
            IImpl_SDK_HardwareSetup_WebOS.prototype.promise_getCPUInfo = function (error, context, callback) {
            };
            IImpl_SDK_HardwareSetup_WebOS.prototype.getSerialNumber = function (error, context, callback) {
            };
            IImpl_SDK_HardwareSetup_WebOS.prototype.promise_getSerialNumber = function (error, context, callback) {
            };
