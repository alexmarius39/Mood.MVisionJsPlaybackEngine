define(["require", "exports"], function (require, exports) {
    ...
    (function (rm_transversalservices) {
        var IImpl_Utils_DateTime_R = /** @class */ (function () {
            ...
            IImpl_Utils_DateTime_R.prototype.getCrtDateTimeAsString2 = function (formatDate, formatTime, separator) {
                ...
                if (crtDate.getFullYear() < 10)
                    strYear = "0" + strYear;
                var crtMonth = crtDate.getMonth() + 1;
            ...
            //----------------------------------------------------------------------
            IImpl_Utils_DateTime_R.prototype.getDateTime = function (aDateTime, strDate) {
            ...
            //------------------------------------
            IImpl_Utils_DateTime_R.prototype.getCrtDateTimeAsISOString = function (aDateTime) {
                var now = new Date();
                aDateTime.setDateTime(now.getFullYear(), now.getMonth() + 1, now.getDate(), now.getHours(), now.getMinutes(), now.getSeconds(), now.getMilliseconds());
                return aDateTime.getAsISOString();
            };
            //------------------------------------
            IImpl_Utils_DateTime_R.prototype.getDateTimeAsISOString = function (aDateTime, strDate) {
                var now = new Date(strDate);
                aDateTime.setDateTime(now.getFullYear(), now.getMonth() + 1, now.getDate(), now.getHours(), now.getMinutes(), now.getSeconds(), now.getMilliseconds());
                return aDateTime.getAsISOString();
            };
            //------------------------------------
            IImpl_Utils_DateTime_R.prototype.getCrtDateTimeAsISOString2 = function () {
                var now = new Date();
            ...
            //----------------------------------------------------------------------
            IImpl_Utils_DateTime_R.prototype.getCrtUTCDateTimeAsISOString = function (aDateTime) {
                var now = new Date();
                aDateTime.setDateTime(now.getUTCFullYear(), now.getUTCMonth() + 1, now.getUTCDate(), now.getUTCHours(), now.getUTCMinutes(), now.getUTCSeconds(), now.getUTCMilliseconds());
                return aDateTime.getAsISOString();
            };
