...
(function (nm_transversalservices) {
    var IImpl_SDK_ApplicationSetup_Tizen = (function () {
        ...
        IImpl_SDK_ApplicationSetup_Tizen.prototype.configureApplicationUrl = function (appServerProperties, error, context, callback) {
            ...
            var srcSoftwareUrlPath = aSoftwareDstFileInfo.getStorage() + aSoftwareDstFileInfo.getPath();
            ...
            try {
                b2bapis.b2bcontrol.setURLLauncherAddress(srcSoftwareUrlPath, onSuccess, onError);
            }
            catch (err2) {
        ...
        IImpl_SDK_ApplicationSetup_Tizen.prototype.installApplication__ = function (appServerProperties, error, context, callback) {
            ...
            var dstSoftwareFileFullName = aSoftwareDstFileInfo.getFullUrlName();
            context.setBoolResult(false);
            var onInstallation = {
            ...
            try {
                ...
                tizen.filesystem.resolve(dstSoftwareFileFullName, function (file) {
