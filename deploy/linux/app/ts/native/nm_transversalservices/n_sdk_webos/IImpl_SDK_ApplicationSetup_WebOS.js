...
(function (nm_transversalservices) {
    var IImpl_SDK_ApplicationSetup_WebOS = (function () {
        ...
        IImpl_SDK_ApplicationSetup_WebOS.prototype.installApplication = function (appServerProperties, error, context, callback) {
        };
        IImpl_SDK_ApplicationSetup_WebOS.prototype.uninstallApplication = function (appServerProperties, error, context, callback) {
        };
        IImpl_SDK_ApplicationSetup_WebOS.prototype.getAppProperties = function (appInstallProperties, error, context, callback) {
        };
        IImpl_SDK_ApplicationSetup_WebOS.prototype.setAppProperties = function (appServerProperties, error, context, callback) {
        };
