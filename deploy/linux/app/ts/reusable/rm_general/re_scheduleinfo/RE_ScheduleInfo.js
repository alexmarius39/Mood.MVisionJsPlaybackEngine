...
var rm_general;
(function (rm_general) {
    var RE_ScheduleInfo = (function (_super) {
        ...
        RE_ScheduleInfo.prototype.copyFromJson = function (jsonScheduleInfo) {
            ...
            for (var k = 0; k < jsonScheduleInfo.service_action_parameters.length; k++) {
                ...
                crtServiceActionParameter.injectDependencies(this._aSrvContainer, this._aSrvLocator, this._aSrvLog, null);
            ...
            for (var j = 0; j < jsonScheduleInfo.service_constraints.length; j++) {
                ...
                crtServiceConstraint.injectDependencies(this._aSrvContainer, this._aSrvLocator, this._aSrvLog, null);
