...
(function (rm_general) {
    var R_SoundProperties = (function (_super) {
        ...
        R_SoundProperties.prototype.copyFromJson = function (jsonSoundProperties) {
            if (jsonSoundProperties != null) {
                this._volumeLevel = jsonSoundProperties._volumeLevel;
                this._mute = jsonSoundProperties._mute;
                this._soundBalance = jsonSoundProperties._soundBalance;
                this._soundMode = jsonSoundProperties._soundMode;
                this._soundSpeaker = jsonSoundProperties._soundSpeaker;
            }
        };
