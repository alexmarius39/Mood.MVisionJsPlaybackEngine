...
(function (rm_general) {
    var R_DateTime = (function (_super) {
        ...
        R_DateTime.prototype.copyFromJson = function (jsonDateTime) {
            this._year = jsonDateTime._year;
            this._month = jsonDateTime._month;
            this._day = jsonDateTime._day;
            this._hour = jsonDateTime._hour;
            this._minutes = jsonDateTime._minutes;
            this._seconds = jsonDateTime._seconds;
            this._milliseconds = jsonDateTime._milliseconds;
            this._strTime = jsonDateTime._strTime;
            this._strDate = jsonDateTime._strDate;
            this._strDateTime = jsonDateTime._strDateTime;
        };
