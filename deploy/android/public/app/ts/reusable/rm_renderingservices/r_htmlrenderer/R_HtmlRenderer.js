    ...
    (function (rm_renderingservices) {
        var R_HtmlRenderer = /** @class */ (function (_super) {
            ...
            R_HtmlRenderer.prototype.prepareNextMediaItem = function (prepareParams, error, context, callback) {
                ...
                if (prepareParams.getRenderParams().getParamHtmlTemplate().getIsHtmlTemplate()) {
                    prepareParams.getRenderParams().getParamHtmlTemplate().incPlayId();
                    strHtmlUrl = prepareParams.getRenderParams().getParamHtmlTemplate().getHtmTemplateFinalUrl();
                    //strHtmlUrl = prepareParams.getRenderParams().getParamHtmlTemplate().getHtmTemplateBasicUrl();
                }
                var owner = this;
                /*
                ...
                //setTimeout( function() 
                {
                    try {
                        if (self._htmlIFrame != null) {
                            //window.Loader.play();
                            //let myWindow = self._htmlIFrame.contentWindow as any;
                            //myWindow.Loader.prototype.play(); Loader.prototype.play
