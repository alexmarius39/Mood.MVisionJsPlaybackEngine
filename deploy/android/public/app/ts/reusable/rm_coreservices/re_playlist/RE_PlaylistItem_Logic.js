...
define(["require", "exports", "../../../../../app/ts/abstract/am_coreservices/ae_playlist/AE_PlaylistItemStatusType", "../../../../../app/ts/abstract/am_coreservices/ae_playlist/AE_PlaylistItemEventType", "../../../../../app/ts/reusable/rm_general/r_entity/R_Entity", "../../../../../app/ts/abstract/am_coreservices/ae_playlist/AE_PlaylistItemType"], function (require, exports, amPlaylistItemStatusType, amPlaylistItemEventType, rmGeneralEntity, amPlaylistItemType) {
    "use strict";
    ...
    (function (rm_coreservices) {
        var RE_PlaylistItem_Logic = /** @class */ (function (_super) {
            ...
            function RE_PlaylistItem_Logic() {
                ...
                _this._canReuseAlreadyCreatedRenderingZone = false;
                _this._canDestroyAlreadyCreatedRenderingZone = false;
                ...
                _this._aSDKService = null;
                return _this;
            }
            //------------------------
            RE_PlaylistItem_Logic.prototype.injectDependencies = function (aSrvContainer, aSrvLocator, aSrvLog, error) {
                _super.prototype.injectDependencies.call(this, aSrvContainer, aSrvLocator, aSrvLog, error);
                var aSDKService = null;
                if (aSrvContainer != null) {
                    aSDKService = aSrvContainer._iServiceManager.getServiceByAbstractName("A_SDK_JsTV", null, null);
                    this._aSDKService = aSDKService;
                }
                return 0;
            };
            //==================================
            RE_PlaylistItem_Logic.prototype.getSDKGoodCrtDate = function () {
            ...
            //============================================
            //----------------------------------------
            RE_PlaylistItem_Logic.prototype.canReuseAlreadyCreatedRenderingZone = function () {
                return this._canReuseAlreadyCreatedRenderingZone;
            };
            //----------------------------------------
            RE_PlaylistItem_Logic.prototype.setCanReuseAlreadyCreatedRenderingZone = function (canReuseAlreadyCreatedRenderingZone) {
            ...
            //============================================
            //----------------------------------------
            RE_PlaylistItem_Logic.prototype.canDestroyAlreadyCreatedRenderingZone = function () {
                return this._canDestroyAlreadyCreatedRenderingZone;
            };
            //----------------------------------------
            RE_PlaylistItem_Logic.prototype.setCanDestroyAlreadyCreatedRenderingZone = function (canDestroyAlreadyCreatedRenderingZone) {
                this._canDestroyAlreadyCreatedRenderingZone = canDestroyAlreadyCreatedRenderingZone;
            };
            //=============================
            //
            //========================
            ...
            //=========================
            RE_PlaylistItem_Logic.prototype.extract_one_or_two_digits_before_char = function (strDuration, strChar) {
                if (strDuration == null)
                    return "0";
                if (strDuration == "")
                    return "0";
                var idx = strDuration.indexOf(strChar);
                if (idx == -1)
                    return "0";
                if (idx == 0)
                    return "0";
                //-- extract 2nd digit
                var strResult2 = strDuration.substring(idx - 1, idx);
                if ((strResult2 < "0") || (strResult2 > "9"))
                    return "0";
                if (idx - 2 < 0)
                    return strResult2;
                //-- extract 1st digit
                var strResult1 = strDuration.substring(idx - 2, idx - 1);
                if ((strResult1 < "0") || (strResult1 > "9"))
                    strResult1 = "";
                //-- return result
            ...
            //=========================
            //"PT23H59M59S"   "PT15M" "PT0S" "PT15M30S"
            RE_PlaylistItem_Logic.prototype.parseJsonDuration = function (strDuration) {
                if (strDuration == null)
                    return null;
                var self = this;
                try {
                    var dtDate = self.getSDKGoodCrtDate(); //new Date(); //ma2 // creates a Date Object using the clients current time
                    var hours = self.extract_one_or_two_digits_before_char(strDuration, "H");
                    var minutes = self.extract_one_or_two_digits_before_char(strDuration, "M");
                    var seconds = self.extract_one_or_two_digits_before_char(strDuration, "S");
            ...
            //=========================
            //"PT23H59M59S"
            RE_PlaylistItem_Logic.prototype.parseJsonDuration_prev = function (strDuration) {
                if (strDuration == null)
                    return null;
                try {
                    ...
                    var str = n.join(":");
                    var dtDate = this.getSDKGoodCrtDate(); //new Date(); //ma2 // creates a Date Object using the clients current time
            ...
            RE_PlaylistItem_Logic.prototype.generateStartDiff_fromNow_toDate = function (dtStartDate) {
                var now = (this.getSDKGoodCrtDate()).getTime(); //(new Date()).getTime(); //ma2
            ...
            RE_PlaylistItem_Logic.prototype.getRealStartDateAsOfToday = function () {
                ...
                if (this._dtStartTime == null)
                    return null;
                var nowDate = this.getSDKGoodCrtDate(); //new Date(); //ma2
            ...
            RE_PlaylistItem_Logic.prototype.hasAtLeastOneAncestorDisable = function (refDate, event, eventQueue, error, aPlaylistController, aRenderingController, context, callback) {
                var id = this.getOwner().getPlaylistItemId();
                var a = 0;
                if (id == 2053)
                    a = 1;
                var crtParent = this.getOwner().getParent();
                if (crtParent == null)
                    return false;
                if (crtParent.getPlaylistItemType() == amPlaylistItemType.am_coreservices.AE_PlaylistItemType.PlaylistItemType_DesignZone)
                    return false;
            ...
            // shutdown
            //================================
            RE_PlaylistItem_Logic.prototype.shutdown = function (error, context, callback) {
