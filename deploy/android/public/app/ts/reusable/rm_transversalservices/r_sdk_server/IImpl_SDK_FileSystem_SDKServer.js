define(["require", "exports"], function (require, exports) {
    ...
    (function (rm_transversalservices) {
        var IImpl_SDK_FileSystem_SDKServer = /** @class */ (function () {
            ...
            //---------------------
            IImpl_SDK_FileSystem_SDKServer.prototype.readBinaryFile = function (storageName, folderName, fileName, error, context, callback) {
                this._owner._aTargetSDK._iSDKFileSystem.readBinaryFile(storageName, folderName, fileName, error, context, callback);
            };
            //-----------------
            ...
            //-----------------------
            //----------------------------
            IImpl_SDK_FileSystem_SDKServer.prototype.getLastModified = function (aFileInfo, error, context, callback) {
                this._owner._aTargetSDK._iSDKFileSystem.getLastModified(aFileInfo, error, context, callback);
            };
            //--------------------------------
