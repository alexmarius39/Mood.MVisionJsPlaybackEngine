...
(function (rm_transversalservices) {
    var IImpl_SDK_TvSignageSetup_SDKConnector = (function () {
        ...
        IImpl_SDK_TvSignageSetup_SDKConnector.prototype.captureScreen = function (captureScreenInfo, error, context, callback) {
            ...
            var callback1 = function (ctx) {
                owner._iNotify_SDKTvSignageSetup.notify_captureScreen(captureScreenInfo, error, context, callback);
            };
            owner._aSDKJsTV._iSDKTvSignageSetup.captureScreen(captureScreenInfo, error, context, callback1);
        };
