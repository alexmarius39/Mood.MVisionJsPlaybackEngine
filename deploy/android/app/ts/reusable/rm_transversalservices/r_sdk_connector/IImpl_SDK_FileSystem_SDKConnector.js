...
(function (rm_transversalservices) {
    var IImpl_SDK_FileSystem_SDKConnector = (function () {
        ...
        IImpl_SDK_FileSystem_SDKConnector.prototype.readBinaryFile = function (storageName, folderName, fileName, error, context, callback) {
            var owner = this._owner;
            var callback2 = function (ctx) {
                console.log(ctx.getResult);
                owner._iNotify_SDKFileSystem.notify_readBinaryFile(storageName, folderName, fileName, error, context, callback);
            };
            owner._aSDKJsTV._iSDKFileSystem.readBinaryFile(storageName, folderName, fileName, error, context, callback2);
        };
        ...
        IImpl_SDK_FileSystem_SDKConnector.prototype.getLastModified = function (aFileInfo, error, context, callback) {
            var owner = this._owner;
            var callback2 = function (ctx) {
                console.log(ctx.getResult);
                owner._iNotify_SDKFileSystem.notify_getLastModified(aFileInfo, error, context, callback);
            };
            owner._aSDKJsTV._iSDKFileSystem.getLastModified(aFileInfo, error, context, callback2);
        };
