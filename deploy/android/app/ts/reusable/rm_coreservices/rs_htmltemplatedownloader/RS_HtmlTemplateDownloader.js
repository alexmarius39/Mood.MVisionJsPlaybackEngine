...
var rmIHtmlTemplateDownloaderConfig = require("../../../../../app/ts/reusable/rm_coreservices/rs_htmltemplatedownloader/RI_HtmlTemplateDownloaderConfig");
var rmIHtmlTemplateDownloaderBuilderMoodV5 = require("../../../../../app/ts/reusable/rm_coreservices/rs_htmltemplatedownloader/RI_HtmlTemplateDownloaderBuilder_Mood_v5");
var rmIHtmlTemplateDownloaderBuilderCustomV1 = require("../../../../../app/ts/reusable/rm_coreservices/rs_htmltemplatedownloader/RI_HtmlTemplateDownloaderBuilder_Custom_v1");
var rmIHtmlTemplateDownloaderMain = require("../../../../../app/ts/reusable/rm_coreservices/rs_htmltemplatedownloader/RI_htmltemplateDownloaderMain");
var rm_coreservices;
(function (rm_coreservices) {
    var RS_HtmlTemplateDownloader = (function (_super) {
        ...
        RS_HtmlTemplateDownloader.prototype.buildAndDownloadHtmlTemplateMainAndDetailFiles_forOneHtmlTemplate = function (aCrtHtmlTemplateFileTransfer, aHtmlTemplateMainFilesTransferList, aHtmlTemplateDetailFilesTransferList, playlistType, aPlaylistTransferFile, aMediaFilesTransferFileBase, aHtmlTemplatesFilesTransferFileBase, error, context, callback) {
            ...
            var callbackCreateFolders = function callbackCreateFolders(ctxCreateFolders) {
                ...
                self.isNewHtmlTemplateFile(self._htmlTemplateFeedDataFile, aHtmlTemplateMainFilesTransferList, aHtmlTemplateDetailFilesTransferList, playlistType, aMediaFilesTransferFileBase, aHtmlTemplatesFilesTransferFileBase, errorIsNewHtmlTemplateFile, contextIsNewHtmlTemplateFile, callbackIsNewHtmlTemplateFile);
            };
            self.addHtmlTemplate_HtmlFeedDataFile(aHtmlTemplateMainFilesTransferList, null, aMediaFilesTransferFileBase, aHtmlTemplatesFilesTransferFileBase, aCrtHtmlTemplateFileTransfer, error, context, callback);
            contextCreateFolders.setRemoteCallback(true);
            self.createFolders_forOneHtmlTemplate_Feed(self._htmlTemplateFeedDataFile, aHtmlTemplateMainFilesTransferList, aHtmlTemplateDetailFilesTransferList, playlistType, null, aMediaFilesTransferFileBase, aHtmlTemplatesFilesTransferFileBase, errorCreateFolders, contextCreateFolders, callbackCreateFolders);
        };
        RS_HtmlTemplateDownloader.prototype.isNewHtmlTemplateFile = function (aCrtHtmlTemplateFileTransfer, aHtmlTemplateMainFilesTransferList, aHtmlTemplateDetailFilesTransferList, playlistType, aMediaFilesTransferFileBase, aHtmlTemplatesFilesTransferFileBase, error, context, callback) {
            var self = this;
