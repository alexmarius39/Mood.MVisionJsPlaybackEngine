...
(function (rm_coreservices) {
    var IImpl_PlaylistDownloaderBuilder_Mood_v5 = (function () {
        ...
        IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.addMediaFile = function (aPlaylistType, aPlaylistItemType, jsonObject, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, mediaId, contentFileId, contentFileName, shaFileValue, contentPlayerFileName, srcFileType, bIsHtmlParameter, error, context, callback) {
            ...
            newMediaFileTransfer.setComputeSha(false);
        ...
        IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadMediaFilesList = function (aPlaylistType, jsonObject, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, error, context, callback) {
        ...
        IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadStreams = function (aPlaylistType, jsonObject, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, error, context, callback) {
        ...
        IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadOneStream = function (aPlaylistType, jsonObject, iStream, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, error, context, callback) {
        ...
        IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadScreenSaver = function (aPlaylistType, jsonObject, iScreenSaverIdx, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, bIsHtmlParameter, error, context, callback) {
        };
        IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadScreenSaverImage = function (aPlaylistType, jsonObject, iScreenSaverIdx, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, bIsHtmlParameter, error, context, callback) {
        };
        IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadScreenSaverVideo = function (aPlaylistType, jsonObject, iScreenSaverIdx, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, bIsHtmlParameter, error, context, callback) {
        };
        IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadStaticMediaItems = function (aPlaylistType, jsonObject, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, bIsHtmlParameter, error, context, callback) {
        ...
        IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadEvents = function (aPlaylistType, jsonObject, iEventsIdx, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, bIsHtmlParameter, error, context, callback) {
        ...
        IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadOneEvent = function (aPlaylistType, jsonObject, iEventItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, bIsHtmlParameter, error, context, callback) {
        ...
        IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadOnePlaylist = function (aPlaylistType, jsonObject, iPlaylist, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, bIsHtmlParameter, error, context, callback) {
            this.loadMediaItems(aPlaylistType, jsonObject, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, bIsHtmlParameter, error, context, callback);
        };
        IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadMediaItems = function (aPlaylistType, jsonObject, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, bIsHtmlParameter, error, context, callback) {
        ...
        IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadOneMediaItem = function (aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, bIsHtmlParameter, error, context, callback) {
        ...
        IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadOneImage = function (aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, bIsHtmlParameter, error, context, callback) {
        ...
        IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadOneVideo = function (aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, bIsHtmlParameter, error, context, callback) {
        ...
        IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadOneWebPage = function (aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, bIsHtmlParameter, error, context, callback) {
        };
        IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadOneHtmlTemplate = function (aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, bIsHtmlParameter, error, context, callback) {
        ...
        IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadOneHtmlFeed = function (aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, bIsHtmlParameter, error, context, callback) {
            if (bIsHtmlParameter == true) {
        ...
        IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadOneDesign = function (aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, bIsHtmlParameter, error, context, callback) {
        ...
        IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadDesignZones = function (aPlaylistType, jsonObject, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, bIsHtmlParameter, error, context, callback) {
        ...
        IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadOneDesignZone = function (aPlaylistType, jsonObject, iDesignZone, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, bIsHtmlParameter, error, context, callback) {
        ...
        IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadOneFillRect = function (aPlaylistType, jsonObject, iFillRectIdx, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, bIsHtmlParameter, error, context, callback, R, G, B, isVisible, strDuration) {
        };
        IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadOneTag = function (aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, bIsHtmlParameter, error, context, callback) {
        };
        IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadStaticMediaItemsInTag = function (aPlaylistType, jsonTagObject, jsonStaticMedias, aPlaylistFile, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, bIsHtmlParameter, error, context, callback) {
        ...
        IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.createOrGeAndSetRealTag = function (nbChildren, aPlaylistType, jsonObject, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, bIsHtmlParameter, error, context, callback) {
        };
        IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadOneEditableFlash = function (aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, bIsHtmlParameter, error, context, callback) {
        };
        IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadOneTvTuner = function (aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, bIsHtmlParameter, error, context, callback) {
        };
        IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadOneTvPassThrough = function (aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, bIsHtmlParameter, error, context, callback) {
        };
        IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadOneAudioFile = function (aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, bIsHtmlParameter, error, context, callback) {
        };
        IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadOneFlash = function (aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplayesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, bIsHtmlParameter, error, context, callback) {
        };
        IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadOnePlaylist2 = function (aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, bIsHtmlParameter, error, context, callback) {
        };
        IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadOneVideoOrAudioStream = function (aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, bIsHtmlParameter, error, context, callback) {
            if (jsonObject == null)
                return;
        ...
        IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadOneVideoStream = function (aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, bIsHtmlParameter, error, context, callback) {
        };
        IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadOneAudioStream = function (aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, bIsHtmlParameter, error, context, callback) {
        };
