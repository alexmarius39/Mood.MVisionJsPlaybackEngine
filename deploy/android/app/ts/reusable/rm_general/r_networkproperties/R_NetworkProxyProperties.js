...
(function (rm_general) {
    var R_NetworkProxyProperties = (function (_super) {
        ...
        R_NetworkProxyProperties.prototype.copyFromJson = function (jsonNetworkProxyProperties) {
            this._isEnabled = jsonNetworkProxyProperties._isEnabled;
            this._ipAddress = jsonNetworkProxyProperties._ipAddress;
            this._password = jsonNetworkProxyProperties._password;
            this._port = jsonNetworkProxyProperties._port;
            this._userName = jsonNetworkProxyProperties._userName;
        };
