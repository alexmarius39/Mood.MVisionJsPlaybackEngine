define(["require", "exports", "../../../../../app/ts/abstract/am_coreservices/ae_playlist/AE_JsonMediaTypeId", "../../../../../app/ts/abstract/am_coreservices/ae_playlist/AE_PlaylistItemType"], function (require, exports, amJsonMediaTypeId, amPlaylistItemType) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var rm_coreservices;
    (function (rm_coreservices) {
        var IImpl_PlaylistDownloaderBuilder_Mood_v5 = /** @class */ (function () {
            //----------- constructor 
            function IImpl_PlaylistDownloaderBuilder_Mood_v5(owner) {
                this._owner = owner;
            }
            //-------------------------------------------
            IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.existsMediaFile = function (mediaId, contentFileId, aPlaylistItemType, mediaFilesList, fileTemplayesFilesList) {
                if (mediaFilesList.has(contentFileId))
                    return true;
                return false;
            };
            //-------------------------------------------
            IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.addMediaFile = function (aPlaylistType, aPlaylistItemType, jsonObject, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, 
            //aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
            mediaId, contentFileId, contentFileName, shaFileValue, contentPlayerFileName, srcFileType, bIsHtmlParameter, error, context, callback) {
                //-----------------------------
                if (bIsHtmlParameter == true) {
                    ...
                    this.addHtmlTemplateFile(aPlaylistType, aPlaylistItemType, jsonObject, parentMediaId, parentContentFileId, parentContentFileName, parentShaFileValue, parentContentPlayerFileName, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, 
                    //aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
                    mediaId, contentFileId, contentFileName, shaFileValue, contentPlayerFileName, srcFileType, bIsHtmlParameter, error, context, callback);
                    return 0;
                }
                ...
                //--- set the source file infos
                // https://harmony.moodmedia.com/v5/medias/${ContentFileID}/parts/${ContentFileName} 
            ...
            mediaId, contentFileId, contentFileName, shaFileValue, contentPlayerFileName, srcFileType, bIsHtmlParameter, error, context, callback) {
                ...
                var extraPath = "";
                if (srcFileType != "htmltemplate") {
                    extraPath = ""; //is not in: parentContentFileId  + "/";
                }
                else {
                    var a = 1;
                }
                ...
                //-- add the newRansfer in media file list
                if (srcFileType == "htmltemplate") //(|| (srcFileType == "htmlfeed"))  
                 {
            ...
            //-----------------------------
            IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.getOnlyFileName = function (strFileName) {
            ...
            //-----------------------------
            IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.getOnlyPath = function (strFileName) {
            ...
            //-------------------------------------------
            //The shared resources are downloaded into the media directory at the specified subpath.
            //E.g.
            // Html_Template_Resources: [ 
            //    "/fonts/font1.fnt",
            //    "/fonts/font2.fnt",
            //    "/icons/facebook.png",
            //    "/icons/instagram.png"
            ...
            //.../media/fonts/font1.fnt
            //.../media/fonts/font2.fnt
            //.../media/icons/facebook.png
            //.../media/icons/instagram.png
            //------------------------------------------
            IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.addHtmlTemplate_ResourceFile = function (aPlaylistType, aPlaylistItemType, jsonObject, jsonObjectIdx, parentMediaId, parentContentFileId, parentContentFileName, parentShaFileValue, parentContentPlayerFileName, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, error, context, callback) {
                var self = this;
                var strKey = 1000 * parentContentFileId + jsonObjectIdx;
                var mediaId = strKey;
                var contentFileId = strKey; //parentContentFileId;       
                var srcFileId = strKey; //parentContentFileId;       
                var srcFileType = "txt";
                var shaFileValue = "";
            ...
            //-------------------------------------------
            /*
            public addHtmlTemplate_ResourceFile(
                     ...
                     error: amGeneralError.am_general.A_Error, context: amGeneralContext.am_general.A_Context, callback) : number
            {
              ...
              var newHtmlTemplateDetailsFileTransfer : amGeneralFileTransfer.am_general.AE_FileTransfer = this._owner._aServiceLocator._iEntityCreation.createDefaultFileTransfer(error);
              newHtmlTemplateDetailsFileTransfer.injectDependencies(null, this._owner._aServiceLocator.,null,null);
              ...
              //---
              // https://harmony.moodmedia.com/v5/medias/${ContentFileID}/files.json
              newHtmlTemplateDetailsFileTransfer.getSrcFileInfo().setStorage(self._owner._aPlaybackGlobalConfig._aHtmlTemplatesFilesRemoteBaseFolder3.getStorage()); //https://harmony.moodmedia.com
              newHtmlTemplateDetailsFileTransfer.getSrcFileInfo().setPath(
                                                            self._owner._aPlaybackGlobalConfig._aHtmlTemplatesFilesRemoteBaseFolder.getPath() + // /v5/medias/
              ...
              newHtmlTemplateDetailsFileTransfer.setSrcShaFileInfo(self._owner.createShaFileInfoFromFileInfo(newHtmlTemplateDetailsFileTransfer.getSrcFileInfo()));
              ...
              newHtmlTemplateDetailsFileTransfer.setTmpShaFileInfo(self._owner.createShaFileInfoFromFileInfo(newHtmlTemplateDetailsFileTransfer.getTmpFileInfo()));
              newHtmlTemplateDetailsFileTransfer.setComputedShaFileInfo(self._owner.createComputedShaFileInfoFromFileInfo(newHtmlTemplateDetailsFileTransfer.getTmpFileInfo()));
              ...
              newHtmlTemplateDetailsFileTransfer.setDstShaFileInfo(self._owner.createShaFileInfoFromFileInfo(newHtmlTemplateDetailsFileTransfer.getDstFileInfo()));
            ...
            */
            //-------------------------------------------
            IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadMediaFilesList = function (aPlaylistType, jsonObject, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, 
            //aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
            error, context, callback) {
                ...
                */
                //----------------
                this.loadStreams(aPlaylistType, jsonObject, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, //this._owner._aPlaylist, 
                error, context, callback);
                /*
                //-------------------
            ...
            //-------------------------------------------------------------------
            IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadStreams = function (aPlaylistType, jsonObject, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, 
            //aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
            error, context, callback) {
                //-------------------- load Streams
                var crtPlaylistStream = null;
                for (var iStream = 0; iStream < jsonObject.Streams_Extended.length; iStream++) {
                    this.loadOneStream(aPlaylistType, jsonObject.Streams_Extended[iStream], iStream, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, //aParent, 
                    error, context, callback);
                    //break; //temp;
                }
            };
            //-------------------------------------------------------------------
            IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadOneStream = function (aPlaylistType, jsonObject, iStream, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, 
            //aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
            error, context, callback) {
                /*
                ...
                */
                ...
                //------------------
                this.loadEvents(aPlaylistType, jsonObject.Channel_Extended, 0, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, //crtPlaylistStream, 
                bIsHtmlParameter, error, context, callback);
                //------------------
                this.loadStaticMediaItems(aPlaylistType, jsonObject.Channel_Extended, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, //crtPlaylistStream,  
                bIsHtmlParameter, error, context, callback);
                //------------------
                var iStream = 0;
                this.loadOnePlaylist(aPlaylistType, jsonObject.Channel_Extended.Playlist_Extended, iStream, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, //crtPlaylistStream, 
                bIsHtmlParameter, error, context, callback);
                //------------------
                this.loadScreenSaver(aPlaylistType, jsonObject.Channel_Extended, 1, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, //crtPlaylistStream, 
                bIsHtmlParameter, error, context, callback);
                //--------------------
            ...
            //-------------------------------------------------------------------
            IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadScreenSaver = function (aPlaylistType, jsonObject, iScreenSaverIdx, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, 
            //aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
            bIsHtmlParameter, error, context, callback) {
                /*
            ...
            //-------------------------------------------------------------------
            IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadScreenSaverImage = function (aPlaylistType, jsonObject, iScreenSaverIdx, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, 
            //aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
            bIsHtmlParameter, error, context, callback) {
                /*
            ...
            //-------------------------------------------------------------------
            IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadScreenSaverVideo = function (aPlaylistType, jsonObject, iScreenSaverIdx, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, 
            //aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
            bIsHtmlParameter, error, context, callback) {
                /*
            ...
            //-------------------------------------------------------------------
            IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadStaticMediaItems = function (aPlaylistType, jsonObject, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, 
            //aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
            bIsHtmlParameter, error, context, callback) {
                /*
                ...
                */
                ...
                for (var iMediaItem = 0; iMediaItem < jsonObject.Medias_Statics_Extended.length; iMediaItem++) {
                    this.loadOneMediaItem(aPlaylistType, jsonObject.Medias_Statics_Extended[iMediaItem], iMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, //crtStaticMediaItems, 
                    bIsHtmlParameter, error, context, callback);
                }
                //-----
            ...
            //-------------------------------------------------------------------
            IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadEvents = function (aPlaylistType, jsonObject, iEventsIdx, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, 
            //aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
            bIsHtmlParameter, error, context, callback) {
                /*
                ...
                */
                ...
                for (var iEventItem = 0; iEventItem < jsonObject.Events.length; iEventItem++) {
                    this.loadOneEvent(aPlaylistType, jsonObject.Events[iEventItem], iEventItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, //crtItemEvents, 
                    bIsHtmlParameter, error, context, callback);
                }
            ...
            //-------------------------------------------------------------------
            IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadOneEvent = function (aPlaylistType, jsonObject, iEventItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, 
            //aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
            bIsHtmlParameter, error, context, callback) {
                /*
                ...
                */
                //--------------------
                this.loadMediaItems(aPlaylistType, jsonObject, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, //crtItemEvent, 
                bIsHtmlParameter, error, context, callback);
            ...
            //-------------------------------------------------------------------
            IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadOnePlaylist = function (aPlaylistType, jsonObject, iPlaylist, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, 
            //aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
            bIsHtmlParameter, error, context, callback) {
                /*
                ...
                */
                //--------------------
                this.loadMediaItems(aPlaylistType, jsonObject, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, //crtItemPlaylist,         
                bIsHtmlParameter, error, context, callback);
                //--------------------
                /*
            ...
            //-------------------------------------------------------------------
            IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadMediaItems = function (aPlaylistType, jsonObject, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, 
            //aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
            bIsHtmlParameter, error, context, callback) {
                //-------------------- load Media Items
                ...
                for (var iMediaItem = 0; iMediaItem < jsonObject.Medias_Extended.length; iMediaItem++) {
                    ...
                    {
                      this.loadOneFillRect(aPlaylistType, jsonObject,  aPlaylistFile,  iRealCrtMediaItem, //aParent,
                                           error, context, callback, 255,0,0, false, "10");
                      iRealCrtMediaItem++;
                    ...
                    this.loadOneMediaItem(aPlaylistType, jsonObject.Medias_Extended[iMediaItem], iRealCrtMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, //aParent, 
                    bIsHtmlParameter, error, context, callback);
                    iRealCrtMediaItem++;
                }
            };
            //-------------------------------------------------------------------
            IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadOneMediaItem = function (aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, 
            //aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
            bIsHtmlParameter, error, context, callback) {
                //-------------------
                ...
                switch (jsonMediaTypeId) {
                    case amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.WEBPAGE:
                        this.loadOneWebPage(aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, //aParent, 
                        bIsHtmlParameter, error, context, callback);
                        break;
                    case amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.EDITABLE_FLASH:
                        this.loadOneEditableFlash(aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, //aParent, 
                        bIsHtmlParameter, error, context, callback);
                        break;
                    case amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.TV_TUNER:
                        this.loadOneTvTuner(aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, //aParent, 
                        bIsHtmlParameter, error, context, callback);
                        break;
                    case amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.TV_PASS_THROUGH:
                        this.loadOneTvPassThrough(aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, //aParent, 
                        bIsHtmlParameter, error, context, callback);
                        break;
                    case amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.MEDIA_STATIC:
                        this.loadOneImage(aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, //aParent, 
                        bIsHtmlParameter, error, context, callback);
                        break;
                    case amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.AUDIO_FILES:
                        this.loadOneAudioFile(aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, //aParent, 
                        bIsHtmlParameter, error, context, callback);
                        break;
                    case amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.MEDIA_STATIC_MOVIE:
                        this.loadOneVideo(aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, //aParent, 
                        bIsHtmlParameter, error, context, callback);
                        break;
                    case amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.HTML_EDITABLE_EXTENDED:
                        this.loadOneHtmlTemplate(aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, //aParent, 
                        bIsHtmlParameter, error, context, callback);
                        break;
                    case amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.HTML_FEED:
                        this.loadOneHtmlFeed(aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, //aParent, 
                        bIsHtmlParameter, error, context, callback);
                        break;
                    case amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.SEQUENCE_EXTENDED:
                        this.loadOneDesign(aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, //aParent, 
                        bIsHtmlParameter, error, context, callback);
                        break;
                    case amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.TAG_EXTENDED:
                        this.loadOneTag(aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, //aParent, 
                        bIsHtmlParameter, error, context, callback);
                        break;
                    case amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.FLASH_OBJECT:
                        this.loadOneFlash(aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, //aParent, 
                        bIsHtmlParameter, error, context, callback);
                        break;
                    case amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.PLAYLIST:
                        this.loadOnePlaylist(aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, //aParent, 
                        bIsHtmlParameter, error, context, callback);
                        break;
                    case amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.VIDEO_OR_AUDIO_STREAM:
                        this.loadOneVideoOrAudioStream(aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, //aParent, 
                        bIsHtmlParameter, error, context, callback);
                        break;
                    default:
            ...
            //-------------------------------------------------------------------
            IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadOneImage = function (aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, 
            //aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
            bIsHtmlParameter, error, context, callback) {
            ...
            //-------------------------------------------------------------------
            IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadOneVideo = function (aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, 
            //aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
            bIsHtmlParameter, error, context, callback) {
            ...
            //-------------------------------------------------------------------
            IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadOneWebPage = function (aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, 
            //aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
            bIsHtmlParameter, error, context, callback) {
                /*
                //----------- case amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.WEBPAGE:
            ...
            //-------------------------------------------------------------------
            IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadOneHtmlTemplate = function (aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, 
            // aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
            bIsHtmlParameter, error, context, callback) {
                ...
                try {
                    for (var j = 0; j < jsonObject.HtmlParameters_Extended.length; j++) {
                        //-------------------------------------------------------------------
                        this.loadOneMediaItem(aPlaylistType, jsonObject.HtmlParameters_Extended[j], j, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, 
                        //aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
                        bIsHtmlParameter2, // -> real html parameters
                        error, context, callback);
                        //-- temporary - to can apply corrective js                             
                        if (jsonObject.HtmlParameters_Extended[j].MediaType == amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.MEDIA_STATIC_MOVIE) {
                            if (aParentHtmlTemplateFileTransfer != null) {
                                aParentHtmlTemplateFileTransfer.setAdditionalInfo("../" + jsonObject.HtmlParameters_Extended[j].ContentPlayerFileName); //:'312372_1280x720_4.mp4'
                            }
                        }
                    }
                    //-----------------------------------------------------------------------------
                    /* test
                    jsonObject.Html_Template_Resources = [
                                                            "/fonts/font1.fnt",
                                                            "/fonts/font2.fnt",
                                                            "/icons/facebook.png",
                                                            "/icons/instagram.png"
                    ...
                    */
                    ...
                    //Helper.logToMain3(`[PlaylistParserError:] ${error}`);
                }
            };
            //-------------------------------------------------------------------
            IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadOneHtmlFeed = function (aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, 
            // aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
            bIsHtmlParameter, error, context, callback) {
                if (bIsHtmlParameter == true) {
            ...
            /*
              ...
              "AspectRatioIDs": [],
              "CreationDate": "\/Date(1615556797857+0100)\/",
              "Description": "http:\/\/rss.cnn.com\/rss\/edition_world.rss",
              "Duration": 0,
              "ID": 69135,
              "IsLocked": false,
              ...
              "LastLock": null,
              "LastModificationDate": "\/Date(1615556797857+0100)\/",
              "LastModifierId": 72,
              "Loop": false,
              "MediaParentId": 69134,
              "MediaType": 36,
              ...
              "FirstDiffusion": "\/Date(1615562258022)\/",
              "LastDiffusion": "\/Date(1678634258022)\/",
              "MediaAccessRights": [],
              "SharingType": -1,
              "StartTime": "PT0S",
              "ContentFileID": 2429,
              "ContentFileName": "2429.xml",
              "ContentFilePlayerShaCode": "EED51382CE9E550B418D14806AFEC8292765CA0AB05479129D54A88F6DF141C7",
              "ContentFileStateID": 5,
              "ContentPlayerFileName": "2429.xml",
              "Flag": null,
              "Properties": null,
            ...
            */
            ...
            /*
                  //------------- params extended
                  if (jsonObject.HtmlParameters_Extended[j].MediaType == amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.MEDIA_STATIC) //Helper.MediaTypeId.MEDIA_STATIC)
                  {
                      // father ContentId Path
                      this.addHtmlTemplateFile( aPlaylistType,
                                 amPlaylistItemType.am_coreservices.AE_PlaylistItemType.PlaylistItemType_Image,
                                 jsonObject,
                                 jsonObject.ContentFileID, jsonObject.ContentFileName, jsonObject.ContentFilePlayerShaCode, jsonObject.ContentPlayerFileName,
                                 mediaFilesList, fileTemplatesFilesList,
                                 aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer,
                                 jsonObject.HtmlParameters_Extended[j].ContentFileID,
                                 jsonObject.HtmlParameters_Extended[j].ContentFileName,
                                 jsonObject.HtmlParameters_Extended[j].ContentFilePlayerShaCode,
                                 jsonObject.HtmlParameters_Extended[j].ContentPlayerFileName, "bin",
                                 bIsHtmlParameter2, error, context, callback) ;
                     /*
                    this.loadOneImage( aPlaylistType, jsonObject.HtmlParameters_Extended[j], iMediaItem,
                                       mediaFilesList, fileTemplatesFilesList,
                                       aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer,//aParent,
                                       error, context, callback);
                     
                    //var dlo = new SamsungSDKDownloader();
                    //var tmp_filename = jsonObject.HtmlParameters_Extended[j].ContentFileName;
                    //var tmp_playerFilename = jsonObject.HtmlParameters_Extended[j].ContentPlayerFileName;
                    //var tmp_id = jsonObject.HtmlParameters_Extended[j].ContentFileID;
                    //dlo.urlToDownload = Helper.getServerUrl(tmp_filename, tmp_id);
                    //dlo.FileId = tmp_id;
                    //dlo.FileName = tmp_filename;
                    //dlo.PlayerFileName = tmp_playerFilename;
                    //Utils.PlaylistMediaDownloader.downList.push(dlo);
                    continue;
                  }
                  //------------- params extended
                  /*
                  if (jsonObject.HtmlParameters_Extended[j].MediaType == amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.MEDIA_STATIC_MOVIE) //Helper.MediaTypeId.MEDIA_STATIC)
                  {
            
                    this.addHtmlTemplateFile( aPlaylistType,
                                 amPlaylistItemType.am_coreservices.AE_PlaylistItemType.PlaylistItemType_Video,
                                 jsonObject,
                                 jsonObject.ContentFileID, jsonObject.ContentFileName, jsonObject.ContentFilePlayerShaCode, jsonObject.ContentPlayerFileName,
                                 mediaFilesList, fileTemplatesFilesList,
                                 aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer,
                                 ...
                                 bIsHtmlParameter2, error, context, callback) ;
                    /*
                    this.loadOneVideo( aPlaylistType, jsonObject.HtmlParameters_Extended[j], iMediaItem,
                                       mediaFilesList, fileTemplatesFilesList,
                                       aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer,//aParent,
                                       error, context, callback);
                  ...
                  if (jsonObject.HtmlParameters_Extended[j].MediaType == amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.FOLDER_RESOURCES)
                  {
                    //Helper.logToMain3(`Folder resources detected!`);
                    ///var cFID = jsonObject.HtmlParameters_Extended[j].ContentFileID;
                    //Helper.logToMain3(`Detected element of type feed! Starting job! ContentFileId is ${cFID}`);
                    //add it to the rss feed array if we cannot find this id
                    /*
                    var fnd = false;
                    Helper.SamsungSKD.videoPlayer1.tizenRSSCollection.map((item) => {
                        if (item.mediaID === cFID) {
                    ...
                    if (!fnd) {
                        Helper.logToMain3(`[ResourceDownloader] Id ${cFID} added to RSS collection!`);
                        resourceDownloader = new TizenServerFolderSync(cFID);
                        Helper.SamsungSKD.videoPlayer1.tizenRSSCollection.push(resourceDownloader);
            
                        // setTimeout(() => {
                        //     resourceDownloader.startJob();
                        // }, 10000);
                    }
            
                    // setTimeout( () => {
                    //     Helper.logToMain3(`[ResourceDownloader] Id ${cFID} will start:`);
                    //     resourceDownloader.startJob();
                    // }, 4000);
                    //   var downObjRSS = new SamsungSDKDownloader();
                    //downObjRSS.urlToDownload = constructedURL;
                    //  downObjRSS.FileId = id;
                    //downObjRSS.FileName = filename;
                    //   downObjRSS.PlayerFileName = "RSSJOB" + cFID;
                    //  dn.rssFeed = resourceDownloader;
                    // var dn = Utils.PlaylistMediaDownloader.addElementToDownloadList(downObjRSS);
                  }
                }*/
            //=======================================================================================================================
            /*
            ...
            */
            //-------------------------------------------------------------------
            IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadOneDesign = function (aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, 
            //aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
            bIsHtmlParameter, error, context, callback) {
                /*
                //--------------- case amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.MEDIA_STATIC_MOVIE:
                ...
                */
                //--------------------
                this.loadDesignZones(aPlaylistType, jsonObject, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, //crtPlaylistItemDesign, 
                bIsHtmlParameter, error, context, callback);
                //--------------------  
                //--------------------
            ...
            //-------------------------------------------------------------------
            IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadDesignZones = function (aPlaylistType, jsonObject, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, 
            //aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
            bIsHtmlParameter, error, context, callback) {
                for (var iDesignZone = 0; iDesignZone < jsonObject.Zones_Extended.length; iDesignZone++) {
                    this.loadOneDesignZone(aPlaylistType, jsonObject.Zones_Extended[iDesignZone], iDesignZone, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, //aParent, 
                    bIsHtmlParameter, error, context, callback);
                }
            };
            //-------------------------------------------------------------------
            IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadOneDesignZone = function (aPlaylistType, jsonObject, iDesignZone, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, 
            //aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
            bIsHtmlParameter, error, context, callback) {
                /*
                //--------------- case amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.MEDIA_STATIC_MOVIE:
                 ...
                 */
                //--------------------
                this.loadOnePlaylist(aPlaylistType, jsonObject.Playlist_Extended, 0, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, //crtPlaylistItemDesignZone, 
                bIsHtmlParameter, error, context, callback);
                /*
                if (!isMainZone)
            ...
            //-------------------------------------------------------------------
            IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadOneFillRect = function (aPlaylistType, jsonObject, iFillRectIdx, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, 
            //aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
            bIsHtmlParameter, error, context, callback, R, G, B, isVisible, strDuration) {
                /*
                //----- case amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.MEDIA_STATIC:
            ...
            //-------------------------------------------------------------------
            IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadOneTag = function (aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, 
            //aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
            bIsHtmlParameter, error, context, callback) {
                /*
                //-------- case amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.TAG_EXTENDED:
            ...
            //------------------------------------------
            IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadStaticMediaItemsInTag = function (aPlaylistType, jsonTagObject, jsonStaticMedias, aPlaylistFile, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, 
            //aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
            bIsHtmlParameter, error, context, callback) {
                //--------------------
                ...
                for (var iTagMediaId = 0; iTagMediaId < jsonTagObject.MEDIA_IDS.length; iTagMediaId++) {
                    ...
                    if (iJsonStaticMediaIdx == -1)
                        continue;
                    this.loadOneMediaItem(aPlaylistType, jsonStaticMedias[iJsonStaticMediaIdx], iTagMediaId, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, //aParent, 
                    bIsHtmlParameter, error, context, callback);
                }
            };
            //--------------------------------------
            IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.getJsonStaticMediaById = function (staticMediaId, jsonStaticMedias) {
            ...
            //-------------------------------------------------------------------
            IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.createOrGeAndSetRealTag = function (nbChildren, aPlaylistType, jsonObject, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, 
            ...
            //-------------------------------------------------------------------
            IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadOneEditableFlash = function (aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, 
            //aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
            bIsHtmlParameter, error, context, callback) {
                //----------- amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.EDITABLE_FLASH:
            };
            //-------------------------------------------------------------------
            IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadOneTvTuner = function (aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, 
            //aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
            bIsHtmlParameter, error, context, callback) {
                //----------- amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.TV_TUNER:
            };
            //-------------------------------------------------------------------
            IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadOneTvPassThrough = function (aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, 
            //aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
            bIsHtmlParameter, error, context, callback) {
                //----------- amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.TV_PASS_THROUGH:
            };
            //-------------------------------------------------------------------
            IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadOneAudioFile = function (aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, 
            //aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
            bIsHtmlParameter, error, context, callback) {
                //-------- case amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.AUDIO_FILES:
            };
            //-------------------------------------------------------------------
            IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadOneFlash = function (aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplayesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, 
            //aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
            bIsHtmlParameter, error, context, callback) {
                //---- case amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.FLASH_OBJECT:
            };
            //-------------------------------------------------------------------
            IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadOnePlaylist2 = function (aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, 
            //aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
            bIsHtmlParameter, error, context, callback) {
                //---   case amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.PLAYLIST:
            };
            //-------------------------------------------------------------------
            IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadOneVideoOrAudioStream = function (aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, 
            //aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
            bIsHtmlParameter, error, context, callback) {
                if (jsonObject == null)
                    return;
                ...
                if (jsonObject.Properties.Type == "VIDEO")
                    return this.loadOneVideoStream(aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, //aParent, 
                    bIsHtmlParameter, error, context, callback);
                if (jsonObject.Properties.Type == "AUDIO")
                    return this.loadOneAudioStream(aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, //aParent, 
                    bIsHtmlParameter, error, context, callback);
                return;
            };
            //-------------------------------------------------------------------
            IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadOneVideoStream = function (aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, 
            //aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
            bIsHtmlParameter, error, context, callback) {
                /*
            ...
            //-------------------------------------------------------------------
            IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.loadOneAudioStream = function (aPlaylistType, jsonObject, iMediaItem, mediaFilesList, fileTemplatesFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, 
            //aParent: amPlaylistContainer.am_coreservices.AE_PlaylistItem_Container,
            bIsHtmlParameter, error, context, callback) {
                /*
                //---- case amJsonMediaTypeId.am_coreservices.AE_JsonMediaTypeId.VIDEO_STREAM:
            ...
            //-------------------------------------------------------
            IImpl_PlaylistDownloaderBuilder_Mood_v5.prototype.getEmptyPlaylist = function () {
                return IImpl_PlaylistDownloaderBuilder_Mood_v5.EMPTY_PLAYLIST;
            };
            IImpl_PlaylistDownloaderBuilder_Mood_v5.EMPTY_PLAYLIST = "{" +
                "\"ID\": 9999," +
                "\"Name\": \"Empty PC\"," +
                "\"PlayerType\": 1," +
                ...
                "]" +
                "}";
            return IImpl_PlaylistDownloaderBuilder_Mood_v5;
        }());
        rm_coreservices.IImpl_PlaylistDownloaderBuilder_Mood_v5 = IImpl_PlaylistDownloaderBuilder_Mood_v5;
...
*/
//# sourceMappingURL=IImpl_PlaylistDownloaderBuilder_Mood_v5.js.map