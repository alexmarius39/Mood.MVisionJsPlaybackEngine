define(["require", "exports"], function (require, exports) {
    ...
    (function (rm_transversalservices) {
        var IImpl_SDK_notifyFileSystem_SDKConsumer_SDKRenderer = /** @class */ (function () {
            ...
            //---------------------
            IImpl_SDK_notifyFileSystem_SDKConsumer_SDKRenderer.prototype.notify_readBinaryFile = function (storageName, folderName, fileName, error, context, callback) {
                this._owner._aSDKRenderer._iFileSystemRenderer.render_text_file(context);
            };
            //-----------------
            ...
            //---------------------
            IImpl_SDK_notifyFileSystem_SDKConsumer_SDKRenderer.prototype.notify_appendTextFile = function (storageName, folderName, fileName, fileContent, error, context, callback) {
                //this._owner._aSDKRenderer._iFileSystemRenderer.render_notify_writeTextFile2(context);
            };
            //---------------------
            ...
            //-----------------
            //--------------------------------
            IImpl_SDK_notifyFileSystem_SDKConsumer_SDKRenderer.prototype.notify_getLastModified = function (aFileInfo, error, context, callback) {
            };
            //----------------------------
