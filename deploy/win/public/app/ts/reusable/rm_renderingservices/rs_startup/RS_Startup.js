...
define(["require", "exports", "./RI_Startup_Main", "./RI_Startup_Config", "../r_renderingservice/R_RenderingService", "../../../abstract/am_general/a_activitylogservicesettings/AE_ActivityLogMessageTypes"], function (require, exports, rmStartupMain, rmStartupConfig, rmRenderingServices, amActivityLogMessageTypes) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var rm_renderingservices;
    (function (rm_renderingservices) {
        var RS_StartupService = /** @class */ (function (_super) {
                        ...
                        var cbGetNTPServerUrl = function (ctx1) {
                            if (ctx1 != null && !ctx1.isError()) {
                                if (ctx1.getBoolResult() === false) {
                                    ...
                                    if (strNTPServer === strNTPServerUrl_1) { // check JS time
