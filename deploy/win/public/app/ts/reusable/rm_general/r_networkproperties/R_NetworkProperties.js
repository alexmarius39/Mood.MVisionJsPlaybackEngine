...
define(["require", "exports", "../../../../../app/ts/reusable/rm_general/r_entity/R_Entity", "../../../../../app/ts/reusable/rm_general/r_networkproperties/R_NetworkCardProperties", "../../../../../app/ts/reusable/rm_general/r_networkproperties/R_NetworkProxyProperties", "../../../../../app/ts/reusable/rm_general/r_networkproperties/R_WifiConnectionInfo"], function (require, exports, rmGeneralEntity, rmGeneralNetworkCardProperties, rmGeneralNetworkProxyProperties, rmGeneralWifiConnectionInfo) {
    ...
    (function (rm_general) {
        var R_NetworkProperties = /** @class */ (function (_super) {
            ...
            R_NetworkProperties.prototype.copyFromJson = function (jsonNetworkProperties) {
                this._wiredNetCardProp.copyFromJson(jsonNetworkProperties._wiredNetCardProp);
                this._wifiNetCardProp.copyFromJson(jsonNetworkProperties._wifiNetCardProp);
                this._proxyNetProp.copyFromJson(jsonNetworkProperties._proxyNetProp);
                this._wifiConnInfo.copyFromJson(jsonNetworkProperties._wifiConnInfo);
            };
            R_NetworkProperties.prototype.getWiredNetCardProperties = function () {
                return this._wiredNetCardProp;
            };
            R_NetworkProperties.prototype.getWifiNetCardProperties = function () {
                return this._wifiNetCardProp;
            };
            R_NetworkProperties.prototype.getProxyNetProperties = function () {
                return this._proxyNetProp;
            };
            R_NetworkProperties.prototype.getWifiConnInfo = function () {
                return this._wifiConnInfo;
            };
