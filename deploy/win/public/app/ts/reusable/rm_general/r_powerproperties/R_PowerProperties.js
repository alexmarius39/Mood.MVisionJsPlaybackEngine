...
define(["require", "exports", "../../../../../app/ts/reusable/rm_general/r_entity/R_Entity"], function (require, exports, rmGeneralEntity) {
    ...
    (function (rm_general) {
        var R_PowerProperties = /** @class */ (function (_super) {
            ...
            R_PowerProperties.prototype.copyFromJson = function (jsonPowerProperties) {
                if (jsonPowerProperties != null) {
                    this._powerCommand = jsonPowerProperties._powerCommand;
                    this._powerMode = jsonPowerProperties._powerMode;
                    this._powerOnDelay_delayTime = jsonPowerProperties._powerOnDelay_delayTime;
                    this._displayPowerMng_mode = jsonPowerProperties._displayPowerMng_mode;
                    this._displayPowerMng_wakeupSignal = jsonPowerProperties._displayPowerMng_wakeupSignal;
                    this._wakedOnLan = jsonPowerProperties._wakedOnLan;
                }
            };
            //------------------------------
            //    power command
