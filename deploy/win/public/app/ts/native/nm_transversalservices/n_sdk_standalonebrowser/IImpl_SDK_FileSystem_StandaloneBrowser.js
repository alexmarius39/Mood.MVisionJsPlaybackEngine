define(["require", "exports"], function (require, exports) {
    ...
    (function (nm_transversalservices) {
        var IImpl_SDK_FileSystem_StandaloneBrowser = /** @class */ (function () {
            ...
            //---------------------
            IImpl_SDK_FileSystem_StandaloneBrowser.prototype.readBinaryFile = function (storageName, folderName, fileName, error, context, callback) {
                //this.readTextFile(storageName + folderName + fileName, error, context, callback);                  
            };
            //---------------------
            ...
            //-----------------------
            //--------------------------------
            IImpl_SDK_FileSystem_StandaloneBrowser.prototype.getLastModified = function (aFileInfo, error, context, callback) {
            };
            //--------------------------------
