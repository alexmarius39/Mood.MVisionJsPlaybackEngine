...
(function (rm_general) {
    var IImpl_Service_R = (function () {
        ...
        IImpl_Service_R.prototype.getServiceLocator = function () {
            return this._owner.getServiceLocator();
        };
        IImpl_Service_R.prototype.setServiceLocator = function (aServiceLocator) {
            return this._owner.setServiceLocator(aServiceLocator);
        };
        IImpl_Service_R.prototype.getServiceContainer = function () {
            return this._owner.getServiceContainer();
        };
        IImpl_Service_R.prototype.setServiceContainer = function (aServiceContainer) {
            return this._owner.setServiceContainer(aServiceContainer);
        };
