...
(function (rm_general) {
    var R_NetworkCardProperties = (function (_super) {
        ...
        R_NetworkCardProperties.prototype.copyFromJson = function (jsonNetworkCardProperties) {
        ...
        R_NetworkCardProperties.prototype.isDynamic = function () {
            return this._isDynamic;
        };
        R_NetworkCardProperties.prototype.setDynamic = function (isDynamic) {
        ...
        R_NetworkCardProperties.prototype.getMacAddress = function () {
            return this._macAddress;
        };
        R_NetworkCardProperties.prototype.setMacAddress = function (macAddress) {
