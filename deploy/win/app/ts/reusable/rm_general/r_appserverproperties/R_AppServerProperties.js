...
(function (rm_general) {
    var R_AppServerProperties = (function (_super) {
        ...
        R_AppServerProperties.prototype.getAppServerUrl = function () {
            return this._appServerUrl;
        };
        R_AppServerProperties.prototype.setAppServerUrl = function (appServerUrl) {
            this._appServerUrl = appServerUrl;
        };
