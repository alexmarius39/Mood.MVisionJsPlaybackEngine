...
(function (rm_renderingservices) {
    var RE_RenderParams_Identification = (function (_super) {
        ...
        RE_RenderParams_Identification.prototype.setStreamId = function (streamId) {
            this._streamId = streamId;
        };
        RE_RenderParams_Identification.prototype.getStreamId = function () {
        ...
        RE_RenderParams_Identification.prototype.copy = function (src) {
            if (src == null)
                return 1;
            this._id = src.getId();
            this._streamId = src.getStreamId();
