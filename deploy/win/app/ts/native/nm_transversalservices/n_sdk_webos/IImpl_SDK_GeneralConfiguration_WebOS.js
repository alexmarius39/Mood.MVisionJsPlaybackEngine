...
(function (nm_transversalservices) {
    var IImpl_SDK_GeneralConfiguration_WebOS = (function () {
        ...
        IImpl_SDK_GeneralConfiguration_WebOS.prototype.getUpTime = function (error, context, callback) {
        };
        IImpl_SDK_GeneralConfiguration_WebOS.prototype.promise_getUpTime = function (error, context, callback) {
        };
