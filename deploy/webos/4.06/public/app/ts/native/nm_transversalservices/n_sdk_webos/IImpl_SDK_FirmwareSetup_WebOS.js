define(["require", "exports", "./cordova/cordova.webos", "./cordova/storage"], function (require, exports) {
    ...
    (function (nm_transversalservices) {
        var IImpl_SDK_FirmwareSetup_WebOS = /** @class */ (function () {
            ...
            IImpl_SDK_FirmwareSetup_WebOS.prototype.getFirmwareVersion = function (error, context, callback) {
            };
            IImpl_SDK_FirmwareSetup_WebOS.prototype.promise_getFirmwareVersion = function (error, context, callback) {
            };
