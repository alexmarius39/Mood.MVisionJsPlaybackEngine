...
define(["require", "exports", "../../../../../app/ts/abstract/am_general/a_activitylogservicesettings/AE_ActivityLogMessageTypes", "../../../../../app/ts/reusable/rm_general/r_service/R_Service", "../../../../../app/ts/reusable/rm_coreservices/rs_htmltemplatedownloader/RI_HtmlTemplateDownloaderConfig", "../../../../../app/ts/reusable/rm_coreservices/rs_htmltemplatedownloader/RI_HtmlTemplateDownloaderBuilder_Mood_v5", "../../../../../app/ts/reusable/rm_coreservices/rs_htmltemplatedownloader/RI_HtmlTemplateDownloaderBuilder_Custom_v1", "../../../../../app/ts/reusable/rm_coreservices/rs_htmltemplatedownloader/RI_htmltemplateDownloaderMain"], function (require, exports, amGeneralActivityLogMessageTypes, rmGeneral, rmIHtmlTemplateDownloaderConfig, rmIHtmlTemplateDownloaderBuilderMoodV5, rmIHtmlTemplateDownloaderBuilderCustomV1, rmIHtmlTemplateDownloaderMain) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    //import { string_to_bytes } from "../../rm_transversalservices/r_utilsservice/asmcryptoes5/other/utils";
    var rm_coreservices;
    (function (rm_coreservices) {
        var RS_HtmlTemplateDownloader = /** @class */ (function (_super) {
            __extends(RS_HtmlTemplateDownloader, _super);
            //----------- constructor 
            function RS_HtmlTemplateDownloader(aFactoryDescription, aServiceContainer, aLogService, error) {
                var _this = _super.call(this, aFactoryDescription, aServiceContainer, aLogService, error) || this;
                _this._iHtmlTemplateDownloaderConfig = new rmIHtmlTemplateDownloaderConfig.rm_coreservices.RI_HtmlTemplateDownloaderConfig(_this);
                _this._iHtmlTemplateDownloaderBuilderMoodV5 = new rmIHtmlTemplateDownloaderBuilderMoodV5.rm_coreservices.RI_HtmlTemplateDownloaderBuilder_Mood_v5(_this);
                _this._iHtmlTemplateDownloaderBuilderCustomV1 = new rmIHtmlTemplateDownloaderBuilderCustomV1.rm_coreservices.RI_HtmlTemplateDownloaderBuilder_Custom_v1(_this);
                _this._iHtmlTemplateDownloaderMain = new rmIHtmlTemplateDownloaderMain.rm_coreservices.RI_HtmlTemplateDownloaderMain(_this);
            ...
            //------------------------------
            RS_HtmlTemplateDownloader.prototype.injectDependencies = function (aServiceContainer, aServiceLocator, aLogService, error) {
            ...
            //----------------------------------------
            RS_HtmlTemplateDownloader.prototype.setSDKService = function (aSDKService) {
            ...
            //---------------------------------------
            //----------------------------
            RS_HtmlTemplateDownloader.prototype.setPlaybackGlobalConfig = function (aPlaybackGlobalConfig) {
            ...
            //-----------------------------
            RS_HtmlTemplateDownloader.prototype.getPlaybackGlobalConfig = function () {
            ...
            //---------------------------------------
            //----------------------------
            RS_HtmlTemplateDownloader.prototype.setDownloadService = function (aDownloadService) {
                this._aDownloadService = aDownloadService;
            };
            //-----------------------------
            RS_HtmlTemplateDownloader.prototype.getDownloadService = function () {
                return this._aDownloadService;
            };
            //--------------------------------------
            // set / get activity log service
            //---------------------------------------
            RS_HtmlTemplateDownloader.prototype.setActivityLogService = function (aActivityLogService) {
                this._aActivityLogService = aActivityLogService;
            };
            //-----------------------------
            RS_HtmlTemplateDownloader.prototype.getActivityLogService = function () {
            ...
            //-----------------------------
            //------------------------------------------------------------
            RS_HtmlTemplateDownloader.prototype.applyCorrectiveJs_forOneHtmlTemplate_forIndexHtmlAppVersion = function (aCrtHtmlTemplateFileTransfer, aHtmlTemplateMainFilesTransferList, aHtmlTemplateDetailFilesTransferList, playlistType, aPlaylistTransferFile, aMediaFilesTransferFileBase, aHtmlTemplatesFilesTransferFileBase, error, context, callback) {
            ...
            //------------------------------------------------------------ //maa
            RS_HtmlTemplateDownloader.prototype.applyCorrectiveJs_forOneHtmlTemplate_forModifiedFile = function (aCrtHtmlTemplateFileTransfer, aHtmlTemplateMainFilesTransferList, aHtmlTemplateDetailFilesTransferList, playlistType, aPlaylistTransferFile, aMediaFilesTransferFileBase, aHtmlTemplatesFilesTransferFileBase, error, context, callback) {
            ...
            //------------------------------------------------------------ //maa
            RS_HtmlTemplateDownloader.prototype.applyCorrectiveJs_forOneHtmlTemplate_forVideoWithText = function (aCrtHtmlTemplateFileTransfer, aHtmlTemplateMainFilesTransferList, aHtmlTemplateDetailFilesTransferList, playlistType, aPlaylistTransferFile, aMediaFilesTransferFileBase, aHtmlTemplatesFilesTransferFileBase, error, context, callback) {
            ...
            //------------------------------------------------------------
            // rss-renderer.js
            RS_HtmlTemplateDownloader.prototype.applyCorrectiveJs_forOneHtmlTemplate_forJsFile = function (strJSFileName, aCrtHtmlTemplateFileTransfer, aHtmlTemplateMainFilesTransferList, aHtmlTemplateDetailFilesTransferList, playlistType, aPlaylistTransferFile, aMediaFilesTransferFileBase, aHtmlTemplatesFilesTransferFileBase, error, context, callback) {
                //--------------------------
                /*
                {
                  context.setError(error);
            ...
            //-------------------------------------------
            RS_HtmlTemplateDownloader.prototype.addHtmlTemplate_HtmlInstanceDataFile = function (htmlTemplatesDetailsFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, aCrtHtmlTemplateFileTransfer, error, context, callback) {
                var self = this;
                var mediaId;
                var contentFileId;
                var contentFileName;
            ...
            //},
            //--------------------------------------------
            RS_HtmlTemplateDownloader.prototype.addHtmlTemplate_HtmlFeedDataFile = function (htmlTemplatesDetailsFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesFolderTransfer, aCrtHtmlTemplateFileTransfer, error, context, callback) {
                var self = this;
                var contentFileId;
                var contentFileName;
                var shaFileValue;
            ...
            //-----------------------------
            RS_HtmlTemplateDownloader.prototype.getFileNameWithoutExtension = function (strFileName) {
            ...
            //-----------------------------
            RS_HtmlTemplateDownloader.prototype.getOnlyFileName = function (strFileName) {
            ...
            //-----------------------------
            RS_HtmlTemplateDownloader.prototype.getOnlyPath = function (strFileName) {
            ...
            //-------------------------------------------
            RS_HtmlTemplateDownloader.prototype.addHtmlTemplate_MediaFile = function (aCrtHtmlTemplateFileTransfer, jsonObject, htmlTemplatesDetailsFilesList, aPlaylistFileTransfer, aMediaFilesFolderTransfer, aHtmlTemplatesFilesTransferFileBase, error, context, callback) {
                var self = this;
                var contentFileId;
                var contentFileName;
                var shaFileValue;
            ...
            //https://harmony.moodmedia.com/v5/medias/${ContentFileID}/files.json
            //------------------------------------------------------------
            RS_HtmlTemplateDownloader.prototype.downloadHtmlTemplateDetailFiles_forOneHtmlTemplate = function (aCrtHtmlTemplateFileTransfer, aHtmlTemplateMainFilesTransferList, aHtmlTemplateDetailFilesTransferList, playlistType, aPlaylistTransferFile, aMediaFilesTransferFileBase, aHtmlTemplatesFilesTransferFileBase, error, context, callback) {
                var self = this;
            ...
            //------------------------------------------------------------
            RS_HtmlTemplateDownloader.prototype.createFolders_forOneHtmlTemplate_Feed = function (aCrtHtmlTemplateFileTransfer, aHtmlTemplateMainFilesTransferList, aHtmlTemplateDetailFilesTransferList, playlistType, aPlaylistFileTransferFile, aMediaFilesTransferFileBase, aHtmlTemplatesFilesTransferFileBase, error, context, callback) {
                var self = this;
                var errorCreateDstFilesFolder = self._aServiceLocator._iEntityCreation.createDefaultError();
                var contextCreateDstFilesFolder = self._aServiceLocator._iEntityCreation.createDefaultContext();
                var callbackCreateDstFilesFolder = function callbackCreateDstFilesFolder(ctxDstFilesFolder) {
                    //-----------------------
                    var errorCreateTmpFilesFolder = self._aServiceLocator._iEntityCreation.createDefaultError();
                    var contextCreateTmpFilesFolder = self._aServiceLocator._iEntityCreation.createDefaultContext();
                    var callbackCreateTmpFilesFolder = function callbackCreateTmpFilesFolder(ctxTmpFilesFolder) {
                        //------------------ end - Ok
                        if (context != null) {
                            context.setError(error);
                            context.setBoolResult(true);
                    ...
                    //document.getElementById("renderer.message").innerHTML += "<p>start create dst file folder"</p>";
                    self._aSDKService._iSDKFileSystem.createFolder2(self._htmlTemplateFeedDataFile.getTmpFileInfo().getStorage(), self._htmlTemplateFeedDataFile.getTmpFileInfo().getPath(), errorCreateTmpFilesFolder, contextCreateTmpFilesFolder, callbackCreateTmpFilesFolder);
                };
                //==========================================
                contextCreateDstFilesFolder.setRemoteCallback(true);
                self._aSDKService._iSDKFileSystem.createFolder2(self._htmlTemplateFeedDataFile.getDstFileInfo().getStorage(), self._htmlTemplateFeedDataFile.getDstFileInfo().getPath(), errorCreateDstFilesFolder, contextCreateDstFilesFolder, callbackCreateDstFilesFolder);
            ...
            //------------------------------------------------------------
            RS_HtmlTemplateDownloader.prototype.buildAndDownloadHtmlTemplateMainFiles_forOneHtmlTemplate_Instance = function (aCrtHtmlTemplateFileTransfer, aHtmlTemplateMainFilesTransferList, aHtmlTemplateDetailFilesTransferList, playlistType, aPlaylistFileTransferFile, aMediaFilesTransferFileBase, aHtmlTemplatesFilesTransferFileBase, error, context, callback) {
                var self = this;
            ...
            RS_HtmlTemplateDownloader.prototype.buildAndDownloadHtmlTemplateMainFiles_forOneHtmlTemplate = function (aCrtHtmlTemplateFileTransfer, aHtmlTemplateMainFilesTransferList, aHtmlTemplateDetailFilesTransferList, playlistType, aPlaylistFileTransferFile, aMediaFilesTransferFileBase, aHtmlTemplatesFilesTransferFileBase, error, context, callback) {
                var self = this;
                if (aCrtHtmlTemplateFileTransfer.getSrcFileType() == "htmlfeed") {
        ...
        */
            //------------------------------------------------------------
            RS_HtmlTemplateDownloader.prototype.unzipHtmlTemplateFile_forOneHtmlTemplate = function (aCrtHtmlTemplateFileTransfer, aHtmlTemplateMainFilesTransferList, aHtmlTemplateDetailFilesTransferList, playlistType, aPlaylistTransferFile, aMediaFilesTransferFileBase, aHtmlTemplatesFilesTransferFileBase, error, context, callback) {
                var self = this;
                //-------------------------- not the main htmltemplate file - nothing to do 
                if (aCrtHtmlTemplateFileTransfer.getSrcFileType() != "htmltemplate") {
                    context.setError(error);
            ...
            //------------------------------------------------------------
            RS_HtmlTemplateDownloader.prototype.cleanHtmlTemplateMainAndDetailFiles_forOneHtmlTemplate = function (aCrtHtmlTemplateFileTransfer, aHtmlTemplateMainFilesTransferList, aHtmlTemplateDetailFilesTransferList, playlistType, aPlaylistTransferFile, aMediaFilesTransferFileBase, aHtmlTemplatesFilesTransferFileBase, error, context, callback) {
                context.setError(error);
                context.setBoolResult(true);
                return callback(context);
                var self = this;
            ...
            //------------------------------------------------------------
            RS_HtmlTemplateDownloader.prototype.buildAndDownloadHtmlTemplateMainAndDetailFiles_forOneHtmlTemplate = function (aCrtHtmlTemplateFileTransfer, aHtmlTemplateMainFilesTransferList, aHtmlTemplateDetailFilesTransferList, playlistType, aPlaylistTransferFile, aMediaFilesTransferFileBase, aHtmlTemplatesFilesTransferFileBase, error, context, callback) {
                var self = this;
                ...
                var callbackCreateFolders = function callbackCreateFolders(ctxCreateFolders) {
                    //--------------------------- start cleanup html templates details files
                    var errorIsNewHtmlTemplateFile = self._aServiceLocator._iEntityCreation.createDefaultError();
                    var contextIsNewHtmlTemplateFile = self._aServiceLocator._iEntityCreation.createDefaultContext();
                        ...
                        if (ctxIsNewHtmlTemplateFile.isError()) {
                            if (context != null) {
                                ...
                                self._aActivityLogService._IActivityLogServiceMessaging
                                    .addLogMessage(amGeneralActivityLogMessageTypes.am_general.AE_LogMessageTypes.Error, self.getServiceName(), "481: isNewHtmltemplateFile - Error while checking for a new htmltemplate file", null, null, null);
                                if (self._debug) {
                    ...
                    aHtmlTemplateMainFilesTransferList, aHtmlTemplateDetailFilesTransferList, playlistType, 
                    //aPlaylistTransferFile: amGeneralFileTransfer.am_general.AE_FileTransfer,
                    aMediaFilesTransferFileBase, aHtmlTemplatesFilesTransferFileBase, errorIsNewHtmlTemplateFile, contextIsNewHtmlTemplateFile, callbackIsNewHtmlTemplateFile);
                };
                //============================================
                self.addHtmlTemplate_HtmlFeedDataFile(aHtmlTemplateMainFilesTransferList, null, //aPlaylistFileTransferFile, 
                aMediaFilesTransferFileBase, aHtmlTemplatesFilesTransferFileBase, aCrtHtmlTemplateFileTransfer, error, context, callback);
                contextCreateFolders.setRemoteCallback(true);
                self.createFolders_forOneHtmlTemplate_Feed(self._htmlTemplateFeedDataFile, //aCrtHtmlTemplateFileTransfer, 
                aHtmlTemplateMainFilesTransferList, aHtmlTemplateDetailFilesTransferList, playlistType, null, //aPlaylistTransferFile: amGeneralFileTransfer.am_general.AE_FileTransfer,
                aMediaFilesTransferFileBase, aHtmlTemplatesFilesTransferFileBase, errorCreateFolders, contextCreateFolders, callbackCreateFolders);
            };
            //--------------------------------
            RS_HtmlTemplateDownloader.prototype.isNewHtmlTemplateFile = function (aCrtHtmlTemplateFileTransfer, aHtmlTemplateMainFilesTransferList, aHtmlTemplateDetailFilesTransferList, playlistType, 
            //aPlaylistTransferFile: amGeneralFileTransfer.am_general.AE_FileTransfer,
            aMediaFilesTransferFileBase, aHtmlTemplatesFilesTransferFileBase, error, context, callback) {
                var self = this;
                //----------------
                ...
                var callbackNotExistsPlaylist = function callbackNotExistsPlaylist(ctx0) {
                    ...
                    var callbackDownloadPlaylist = function callbackDownloadPlaylist(ctx1) {
                        ...
                        if (ctx1.isError()) {
                            ...
                            self._aActivityLogService._IActivityLogServiceMessaging
                                .addLogMessage(amGeneralActivityLogMessageTypes.am_general.AE_LogMessageTypes.Error, self.getServiceName(), "4889: isNewHtmlTemplateFile:: download HtmlTemplate File: [\"" + ctx1.getError().getErrMsg() + "\"]", null, null, null);
                            if (context != null) {
                                context.setError(error);
                                //context.setBoolResult(true);
                                return callback(context);
                        ...
                        var callbackDownloadPlaylistSha = function callbackDownloadPlaylistSha(ctx2) {
                            if (ctx2.isError()) {
                                ...
                                if (context != null) {
                                    ...
                                    self._aActivityLogService._IActivityLogServiceMessaging
                                        .addLogMessage(amGeneralActivityLogMessageTypes.am_general.AE_LogMessageTypes.Error, self.getServiceName(), "4890: isNewHtmlTemplateFile:: download HtmlTemplate File Sha: [\"" + ctx2.getError().getErrMsg() + "\"]", null, null, null);
                                    if (self._debug) {
                            ...
                            var callbackComputeSha = function callbackComputeSha(ctx3) {
                                if (ctx3.isError()) {
                                    ...
                                    if (context != null) {
                                        ...
                                        self._aActivityLogService._IActivityLogServiceMessaging
                                            .addLogMessage(amGeneralActivityLogMessageTypes.am_general.AE_LogMessageTypes.Error, self.getServiceName(), "4890: isNewHtmlTemplateFile:: HtmlTemplate File: error compute sha: [\"" + ctx3.getError().getErrMsg() + "\"]", null, null, null);
                                        if (self._debug) {
                                ...
                                var callbackReadTmpShaFile = function callbackReadTmpShaFile(ctx4) {
                                    if (ctx4.isError()) {
                                        ...
                                        if (context != null) {
                                            ...
                                            self._aActivityLogService._IActivityLogServiceMessaging
                                                .addLogMessage(amGeneralActivityLogMessageTypes.am_general.AE_LogMessageTypes.Error, self.getServiceName(), "4892: isNewHtmlTemplateFile: readTmpShaFile: [\"" + ctx3.getError().getErrMsg() + "\"]", null, null, null);
                                            if (self._debug) {
            ...
            //-------------------------------------------------                  
            RS_HtmlTemplateDownloader.prototype.buildAndDownloadAllHtmlTemplatesMainAndDetailFiles_fromMap = function (transferMediaFiles, playlistType, aPlaylistTransferFile, aMediaFilesTransferFileBase, aHtmlTemplatesFilesTransferFileBase, error, context, callback) {
            ...
            //-------------------------------------------------                  
            RS_HtmlTemplateDownloader.prototype.buildAndDownloadAllHtmlTemplatesMainAndDetailFiles_fromArray = function (transferMediaFiles, playlistType, aPlaylistTransferFile, aMediaFilesTransferFileBase, aHtmlTemplatesFilesTransferFileBase, error, context, callback) {
                var self = this;
            ...
            //--------------------------------
            RS_HtmlTemplateDownloader.prototype.downloadHtmlTemplatesFilesList = function (playlistType, aPlaylistTransferFile, aMediaFilesTransferFileBase, aHtmlTemplatesFilesTransferFileBase, error, context, callback) {
            ...
            //--------------------------------
            RS_HtmlTemplateDownloader.prototype.buildAndDownloadHtmlTemplatesFilesList = function (playlistType, aPlaylistTransferFile, aMediaFilesTransferFileBase, aHtmlTemplatesFilesTransferFileBase, error, context, callback) {
                var self = this;
            ...
            //------------------------------------
            //--------------------------------
            RS_HtmlTemplateDownloader.prototype.downloadPlaylist = function (playlistType, aPlaylistTransferFile, aMediaFilesTransferFileBase, aHtmlTemplatesFilesTransferFileBase, error, context, callback) {
                //----------------
                var self = this;
            ...
            //--------------------------------
            RS_HtmlTemplateDownloader.prototype.buildMediaFilesListToDownload = function (playlistType, aPlaylistTransferFile, aMediaFilesTransferFileBase, aHtmlTemplatesFilesTransferFileBase, error, context, callback) {
                var self = this;
            ...
            //--------------------------------
            RS_HtmlTemplateDownloader.prototype.downloadMediaFilesList = function (playlistType, aPlaylistTransferFile, aMediaFilesTransferFileBase, aHtmlTemplatesFilesTransferFileBase, error, context, callback) {
                var bIgnoreErrors = false;
            ...
            //--------------------------------
            RS_HtmlTemplateDownloader.prototype.hasNewPlaylist = function (playlistType, aPlaylistTransferFile, aMediaFilesTransferFileBase, aHtmlTemplatesFilesTransferFileBase, error, context, callback) {
                var self = this;
                //----------------
                var self = this;
            ...
            //-----------------------------------
            RS_HtmlTemplateDownloader.prototype.cleanupCurrentHtmlTemplatesFiles = function (playlistType, aPlaylistTransferFile, aMediaFilesTransferFileBase, aHtmlTemplatesFilesTransferFileBase, error, context, callback) {
                //--------------------------------------
                var self = this;
            ...
            //-----------------------------------
            RS_HtmlTemplateDownloader.prototype.cleanupCurrentPlaylistAndMediaFiles = function (playlistType, aPlaylistTransferFile, aMediaFilesTransferFileBase, aHtmlTemplatesFilesTransferFileBase, error, context, callback) {
                //--------------------------------------
                var self = this;
                var aPlaylistTmpFolder = aPlaylistTransferFile.getTmpFileInfo();
                var aMediaFilesTmpFolder = aMediaFilesTransferFileBase.getTmpFileInfo();
            ...
            //-----------------------------------
            RS_HtmlTemplateDownloader.prototype.downloadPlaylistAndMediaFiles = function (playlistType, aPlaylistTransferFile, aMediaFilesTransferFileBase, aHtmlTemplatesFilesTransferFileBase, error, context, callback) {
                var self = this;
            ...
            //====================================================
            RS_HtmlTemplateDownloader.prototype.downloadAll = function (playlistType, aPlaylistTransferFile, aMediaFilesTransferFileBase, aHtmlTemplatesFilesTransferFileBase, error, context, callback) {
                var self = this;
            ...
            //====================================================
            RS_HtmlTemplateDownloader.prototype.createComputedShaFileInfoFromFileInfo = function (aFileInfo) {
            ...
            //====================================================
            RS_HtmlTemplateDownloader.prototype.createShaFileInfoFromFileInfo = function (aFileInfo) {
                var aShaFileInfo = this._aServiceLocator._iEntityCreation.createDefaultFileInfo(null);
                aShaFileInfo.setStorage(aFileInfo.getStorage());
                aShaFileInfo.setPath(aFileInfo.getPath());
            ...
            //========================================================
            RS_HtmlTemplateDownloader.prototype.createFoldersIfTheyNotExists = function (playlistType, aPlaylistTransferFile, aMediaFilesTransferFileBase, aHtmlTemplatesFilesTransferFileBase, error, context, callback) {
                var self = this;
            ...
            //====================================================
            RS_HtmlTemplateDownloader.prototype.download = function (error, context, callback) {
                var self = this;
                ...
                var callbackCreateFolders = function callbackCreateFolders() {
                    ...
                    self.downloadAll_new(playlistType, aPlaylistTransfer, aMediaFilesTransfer, aHtmlTemplatesFilesTransfer, error, context, callbackDownloadAll);
                };
            ...
            //========================================================
            //-----------------------------------
            RS_HtmlTemplateDownloader.prototype.downloadPlaylistAndMediaFiles_new = function (playlistType, aPlaylistTransferFile, aMediaFilesTransferFileBase, aHtmlTemplatesFilesTransferFileBase, error, context, callback) {
                var self = this;
                //self._fileTransferList = new Array<amGeneralFileTransfer.am_general.AE_FileTransfer>();
                //----------------
                var errorDownloadPlaylist = self._aServiceLocator._iEntityCreation.createDefaultError();
            ...
            //====================================================
            RS_HtmlTemplateDownloader.prototype.downloadAll_new = function (playlistType, aPlaylistTransferFile, aMediaFilesTransferFileBase, aHtmlTemplatesFilesTransferFileBase, error, context, callback) {
                var self = this;
                var bHasNewPlaylist = false;
                var errorHasNewPlaylist = self._aServiceLocator._iEntityCreation.createDefaultError();
                var contextHasNewPlaylist = self._aServiceLocator._iEntityCreation.createDefaultContext();
                var callbackHasNewPlaylist = function callbackHasNewPlaylist(ctxHasNewPlaylist) {
                    ...
                    var callbackCleanup = function callbackCleanup() {
                        ...
                        contextDownload.setRemoteCallback(true);
                        self.downloadPlaylistAndMediaFiles_new(playlistType, aPlaylistTransferFile, aMediaFilesTransferFileBase, aHtmlTemplatesFilesTransferFileBase, errorDownload, contextDownload, callbackDownload);
                    };
                    //====================================
                    // cleanupCurrentPlaylistAndMediaFiles 
                    //=====================================
            ...
            //=================================================
            //---------------------------------------------------------
            RS_HtmlTemplateDownloader.prototype.setInterruptCallback = function (interruptCallback) {
                this._interruptCallback = interruptCallback;
                if (this._aDownloadService != null)
                    this._aDownloadService._iServiceRun.setInterruptCallback(interruptCallback);
            };
            //-----------------------------------------------------
            RS_HtmlTemplateDownloader.prototype.run = function (error, context, callback) {
                var self = this;
            ...
            //-----------------------------
            RS_HtmlTemplateDownloader.prototype.shutdown = function (error, context, callback) {
            ...
            return RS_HtmlTemplateDownloader;
        }(rmGeneral.rm_general.R_Service));
        rm_coreservices.RS_HtmlTemplateDownloader = RS_HtmlTemplateDownloader;
    })(rm_coreservices = exports.rm_coreservices || (exports.rm_coreservices = {}));
});
//# sourceMappingURL=RS_HtmlTemplateDownloader.js.map